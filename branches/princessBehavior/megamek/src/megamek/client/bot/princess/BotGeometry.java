...
public class BotGeometry {
    ...
    static void debugSelfTest(Princess owningPrincess) {
        ...
        Logger.methodBegin(BotGeometry.class, METHOD_NAME);

        try {
            Logger.log(BotGeometry.class, METHOD_NAME, "Performing self test of geometry");
            Coords center = new Coords(4, 6);
            HexLine[] lines = new HexLine[6];
            for (int i = 0; i < 6; i++) {
                lines[i] = new HexLine(center, i);
            }
            Logger.log(BotGeometry.class, METHOD_NAME, "Testing that center lies in lines... ");
            boolean passed = true;
            for (int i = 0; i < 6; i++) {
            ...
            if (passed) {
                Logger.log(BotGeometry.class, METHOD_NAME, "Passed");
            } else {
                Logger.log(BotGeometry.class, METHOD_NAME, "Failed");
            }
            Logger.log(BotGeometry.class, METHOD_NAME, "Testing more points that should lie on lines... ");
            passed = true;
            for (int i = 0; i < 6; i++) {
            ...
            passed = true;
            Logger.log(BotGeometry.class, METHOD_NAME, "Testing points to left and right of lines... ");
            for (int i = 0; i < 6; i++) {
                //            System.err.println("direction="+i);
            ...
            Logger.log(BotGeometry.class, METHOD_NAME, "Checking area contains proper points... ");
            ...
            passed = true;
            Logger.log(BotGeometry.class, METHOD_NAME, "Checking area doesn't contain extra points... ");
            ...
            Logger.methodEnd(BotGeometry.class, METHOD_NAME);
        }
    }
}
