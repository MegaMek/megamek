...
public class BehaviorSettingsFactoryTestConstants {
    ...
    public static final String NM_COWARDLY = "cowardly";
    /**
     * Home Edge: {@link HomeEdge#NORTH} <br>
    ...
    public static final String NM_ESCAPE = "escape";
    /**
     * Home Edge: {@link HomeEdge#NORTH} <br>
     * Forced Withdrawal: True <br>
     * Go Home: True <br>
    ...
    public static final String NM_DEFAULT = BehaviorSettings.DEFAULT_DESC;
    /**
     * Home Edge: {@link HomeEdge#NORTH} <br>
     * Forced Withdrawal: True <br>
     * Go Home: False <br>
