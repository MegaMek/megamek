...
public class OffboardAttackPhaseDisplay
...
//    private Button            butReport;
     ...
     */
    public OffboardAttackPhaseDisplay(ClientGUI clientgui) {
...
//         addBag(client.cb.getComponent(), gridbag, c);
    ...
    private void endMyTurn() {
        ...
        if ( Game.PHASE_OFFBOARD == client.game.getPhase()
             && null != next
             && null != ce()
    ...
    public void gameTurnChange(GameEvent ev) {
        ...
        if(client.game.getPhase() == Game.PHASE_OFFBOARD) {
            endMyTurn();
    ...
    public void gamePhaseChange(GameEvent ev) {
        ...
        if(client.isMyTurn() && client.game.getPhase() != Game.PHASE_OFFBOARD) {
            endMyTurn();
        }
