...
public interface IHex extends Cloneable{
    ...
    /**
     * The theme is intended as a tag for the tileset file to 
     * indicate a special graphic for the hex.
     * 
     * @return theme name
     */
    ...
    /**
     * @return the highest level that features in this hex extend to.  Above
    ...
    /**
     * @return the lowest level that features in this hex extend to.  Below
     ...
     * 
     * @param type
     * @return the terrain of the specified type, or <code>null</code>
