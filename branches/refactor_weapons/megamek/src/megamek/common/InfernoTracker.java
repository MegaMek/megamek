...
/**
 * This class records and defines the effects of hits by Inferno rounds
 * on units and hexes.  It does not *apply* the effect, it just defines it.
 * <p/>
  ...
  implements Serializable, RoundUpdated
{
  ...
  private int         burnRoundsPerHit;      
     ...
     *
     * @param   round - the <code>Inferno</code> round that hits.
     *          If this value is not <code>STANDARD_ROUND</code> or
     ...
     *          still burning.  <code>false</code> if no inferno rounds have
     *          hit yet, or if they have burned out.
     */
     ...
     *          hex will suffer the effects of an Inferno round (either
     *          standard <b>or</b> Inferno IV).  This number will be
