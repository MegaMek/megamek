...
public class Server implements Runnable {
    ...
    private void endCurrentPhase() {
        switch (game.getPhase()) {
            ...
            case IGame.PHASE_PHYSICAL_REPORT :
                ...
                break;
            case IGame.PHASE_TARGETING :
                vPhaseReport.addElement(new Report(1040, Report.PUBLIC));
                resolveOnlyWeaponAttacks();
                handleAttacks();
                //check reports
                if (vPhaseReport.size() > 1) {
     ...
     */
    public void deliverThunderAugMinefield( Coords coords,
    ...
    */
    ...
    private void resolveOnlyWeaponAttacks() {       
        ...
        // loop thru received attack actions, getting the AttackHandlers
        for (Enumeration i = game.getActions(); i.hasMoreElements();) {
            Object o = i.nextElement();
            if (o instanceof WeaponAttackAction) {
                WeaponAttackAction waa = (WeaponAttackAction)o;
    ...
    public void tryClearHex(Coords c, int nTarget, int entityId) {
...
*/
     ...
     */
    public Vector criticalEntity(Entity en, int loc) {
