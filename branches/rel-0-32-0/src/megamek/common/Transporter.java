...
/**
 * Classes that implement this interface have the ability to load, carry,
 * and unload units in the game.  It is anticipated that classes will exist
 * for passenger compartments, battle armor steps, Mek bays, Aerospace
 * hangers, and vehicle garages.  Other possible classes include cargo bays
 * and Dropship docks.
 */
