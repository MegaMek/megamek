...
public class MechPanelTabStrip extends PicMap {
    ...
    private void setImages() {
        ...
        idleImage[1] = tk.getImage(new File(Configuration.widgetsDir(), "tab_armor_idle.gif").toString()); //$NON-NLS-1$
        idleImage[2] = tk.getImage(new File(Configuration.widgetsDir(), "tab_systems_idle.gif").toString()); //$NON-NLS-1$
        idleImage[3] = tk.getImage(new File(Configuration.widgetsDir(), "tab_weapon_idle.gif").toString()); //$NON-NLS-1$
        idleImage[4] = tk.getImage(new File(Configuration.widgetsDir(), "tab_extras_idle.gif").toString()); //$NON-NLS-1$
        activeImage[0] = tk.getImage(new File(Configuration.widgetsDir(), "tab_general_active.gif").toString()); //$NON-NLS-1$
        activeImage[1] = tk.getImage(new File(Configuration.widgetsDir(), "tab_armor_active.gif").toString()); //$NON-NLS-1$
        activeImage[2] = tk.getImage(new File(Configuration.widgetsDir(), "tab_systems_active.gif").toString()); //$NON-NLS-1$
        activeImage[3] = tk.getImage(new File(Configuration.widgetsDir(), "tab_weapon_active.gif").toString()); //$NON-NLS-1$
        activeImage[4] = tk.getImage(new File(Configuration.widgetsDir(), "tab_extras_active.gif").toString()); //$NON-NLS-1$
