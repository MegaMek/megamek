...
public class TilesetManager implements IPreferenceChangeListener, ITilesetManager {
    ...
    public void loadNeededImages(IGame game) {
        ...
        // load minefield sign
        minefieldSign = comp.getToolkit().getImage(new File(Configuration.hexesDir(), Minefield.FILENAME_IMAGE).toString());

        // load night overlay
        nightFog = comp.getToolkit().getImage(new File(Configuration.hexesDir(), FILENAME_NIGHT_IMAGE).toString());
