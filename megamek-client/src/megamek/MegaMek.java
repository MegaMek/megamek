...
public class MegaMek {
    ...
    private static void showInfo() {
        ...
        System.out.println("Starting MegaMek v" + MegaMekUtil.VERSION + " ..."); //$NON-NLS-1$ //$NON-NLS-2$
        System.out.println("Compiled on " + new Date(MegaMekUtil.TIMESTAMP).toString()); //$NON-NLS-1$
