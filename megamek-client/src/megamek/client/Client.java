 ...
 */
public class Client implements IClientCommandHandler, IClient {
    ...
    protected void handlePacket(Packet c) {
        ...
        switch (c.getCommand()) {
            ...
            case Packet.COMMAND_SERVER_GREETING:
                ...
                versionData[0] = MegaMekUtil.VERSION;
                versionData[1] = MegaMekUtil.getMegaMekSHA256();
