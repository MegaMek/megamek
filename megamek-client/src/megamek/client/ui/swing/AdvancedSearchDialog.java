...
import megamek.common.util.AdvancedSearch.FilterTokens;
import megamek.common.util.AdvancedSearch.OperationFT;
import megamek.common.util.AdvancedSearch;
    ...
    public void actionPerformed(java.awt.event.ActionEvent ev) {
        ...
        //Cancel Button Clicked
            ...
            if (row >= 0){
                ...
                filterToks.add(advancedSearch.getEquipmentFT(internalName,fullName,qty));
            ...
            filterToks.add(advancedSearch.getParensFT("("));
            txtEqExp.setText(filterExpressionString());
            btnBack.setEnabled(true);
            ...
            filterToks.add(advancedSearch.getOperationFT(MechSearchFilter.BoolOp.AND));
            txtEqExp.setText(filterExpressionString());
            btnBack.setEnabled(true);
            disableOperationButtons();
            enableSelectionButtons();
        }else if (ev.getSource().equals(btnOr)){
            filterToks.add(advancedSearch.getOperationFT(MechSearchFilter.BoolOp.OR));
            txtEqExp.setText(filterExpressionString());
            btnBack.setEnabled(true);
            disableOperationButtons();
            enableSelectionButtons();
