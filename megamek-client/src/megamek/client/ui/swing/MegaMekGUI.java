...
import static megamek.common.server.Compute.d6;
...
import megamek.common.util.MegaMekUtil;
...
public class MegaMekGUI implements IMegaMekGUI {
    ...
    private void createGUI() {
        ...
        if (GUIPreferences.getInstance().getNagForReadme()) {
            ConfirmDialog confirm = new ConfirmDialog(
                    frame,
                    Messages.getString("MegaMek.welcome.title") + MegaMekUtil.VERSION, //$NON-NLS-1$
    ...
    private void showMainMenu() {
        ...
        labVersion
                .setText(Messages.getString("MegaMek.Version") + MegaMekUtil.VERSION); //$NON-NLS-1$
