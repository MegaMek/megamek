...
public class MechSearchFilter {
    ...
    public void createFilterExpressionFromTokens(
            Vector<AdvancedSearch.FilterTokens> toks)
    ...
    private ExpNode createFTFromTokensRecursively(
            Iterator<AdvancedSearch.FilterTokens> toks, 
        ...
        AdvancedSearch.FilterTokens filterTok = toks.next();
        
        // Parsing Parenthesis
        if (filterTok instanceof AdvancedSearch.ParensFT) {
            if (((AdvancedSearch.ParensFT) filterTok).parens.equals("(")){
                if (currNode == null){
            ...
            } else if (((AdvancedSearch.ParensFT) filterTok).parens
                    .equals(")")){
        ...
        if (filterTok instanceof AdvancedSearch.OperationFT){
            AdvancedSearch.OperationFT ft = 
                (AdvancedSearch.OperationFT) filterTok;
        ...
        //Parsing an Operand
        if (filterTok instanceof AdvancedSearch.EquipmentFT){
          if (currNode == null){
              currNode = new ExpNode();
          }
          AdvancedSearch.EquipmentFT ft = 
              (AdvancedSearch.EquipmentFT)filterTok;
