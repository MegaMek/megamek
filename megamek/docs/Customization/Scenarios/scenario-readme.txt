...
# Here is where you specify a "Unit" (be it Mek, Infantry, Vehicle or BattleArmor) for side A.
# Format is as follows:
# Unit name (Must match Faction List) Unit Number. Must be sequential, if a number is skipped, it will not place
# the units after it.
# Mek Type with variant Pilot Name Pilot,Gunnery skills Facing.
...
# Lastly you can damage the mek pilot directly by assigning the pilot hits.
