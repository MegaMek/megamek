...
public class Memory {
     ...
     *
     * @param key   the key to which the value will be associated, if the key already exists, the value will be
     *              replaced
     * @param value the value to be stored. It can be any object, but it is recommended to use the same type of object
     *              for the same key
     */
    ...
    /**
     * Gets a memory. It will return an optional to protect you from null pointers, so you have to check prior to
     * accessing it.
     *
     ...
     * @param key the key to get the memory from
     *
     * @return an optional with the stored value as a string, or an empty optional if the key is not found or the value
     *       is not a string
     */
     ...
     * @param key the key to get the memory from
     *
     * @return an optional with the stored value as an integer, or an empty optional if the key is not found or the
     ...
     * @param key the key to get the memory from
     *
     * @return an optional with the stored value as a double, or an empty optional if the key is not found or the value
     *       is not a double
     */
     ...
     * @param key the key to get the memory from
     *
     * @return an optional with the stored value as a long, or an empty optional if the key is not found or the value is
     *       not a long
     */
     ...
     * @param key the key to get the memory from
     *
     * @return an optional with the stored value as a boolean, or an empty optional if the key is not found or the value
     *       is not a boolean
     */
