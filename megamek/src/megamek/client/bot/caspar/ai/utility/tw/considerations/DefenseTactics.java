...
/**
 * This consideration is used to determine the defense tactics to use
 * It sets the use of mobile defense, static defense, or others
 */
@JsonTypeName("DefenseTactics")
public class DefenseTactics extends TWConsideration {
    ...
    @Override
    public DefenseTactics copy() {
        var copy = new DefenseTactics();
