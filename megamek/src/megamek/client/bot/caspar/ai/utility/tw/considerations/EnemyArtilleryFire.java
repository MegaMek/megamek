...
/**
 * This consideration is used to determine enemy artillery fire risk
 */
@JsonTypeName("EnemyArtilleryFire")
public class EnemyArtilleryFire extends TWConsideration {
    ...
    @Override
    public EnemyArtilleryFire copy() {
        var copy = new EnemyArtilleryFire();
