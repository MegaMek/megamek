 ...
 */
@JsonTypeName("StayOutOfRange")
public class StayOutOfRange extends TWConsideration {

    public static final String descriptionKey = "StayOutOfRange";

    public StayOutOfRange() {
    }
