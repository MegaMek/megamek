...
public class BehaviorSettingsFactory {
     ...
     */
    private final BehaviorSettings BERSERK_BEHAVIOR = buildBerserkBehavior();
    static final String BERSERK_BEHAVIOR_DESCRIPTION = "BERSERK";
     ...
     * Strategic Targets: None
     */
    private final BehaviorSettings ESCAPE_BEHAVIOR = buildEscapeBehavior();
    static final String ESCAPE_BEHAVIOR_DESCRIPTION = "ESCAPE";
