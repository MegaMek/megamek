...
public enum ChatCommands {
    ...
    AERO_FOCUS("af",
          "aero-focus",
          Messages.getString("Princess.command.aeroFocus.description"),
          new AeroFocusCommand()),
    AERO_LIFT("al",
          "aero-lift",
          Messages.getString("Princess.command.aeroLift.description"),
          new AeroLiftCommand()),
    HOLD_POSITION("hp",
          "hold-position",
    ...
    RADIO_CHATTER("rc",
          "radio-chatter",
          Messages.getString("Princess.command.radioChatter.description"),
          new RadioChatterCommand()),
    SHOOT_AND_SCOOT("ss",
          "shoot-and-scoot",
