...
public class ProbabilityCalculator {
    ...
    public static final double[] hit_probabilities_front = { 1d / 36, 7d / 36, 5d / 36, 5d / 36, 5d / 36, 5d / 36, 4d / 36, 4d / 36 };
    public static final double[] hit_probabilities_rside = { 1d / 36, 5d / 36, 7d / 36, 4d / 36, 7d / 36, 3d / 36, 7d / 36, 3d / 36 };
    public static final double[] hit_probabilities_lside = { 1d / 36, 5d / 36, 4d / 36, 7d / 36, 3d / 36, 7d / 36, 3d / 36, 7d / 36 };

    //How likely am I to hit a certain location with a punch, given what direction the fire is coming from
    //Order is: LOC_HEAD,LOC_CT,LOC_RT,LOC_LT,LOC_RARM,LOC_LARM,LOC_RLEG,LOC_LLEG Defined in megamek.common.Mech
    public static final double[] hit_probabilities_punch_front = { 1d / 6, 1d / 6, 1d /6, 1d / 6, 1d / 6, 1d / 6, 0, 0 };
    public static final double[] hit_probabilities_punch_rside = { 1d / 6, 1d / 6, 2d /6, 0, 2d / 6,  0, 0, 0 };
    public static final double[] hit_probabilities_punch_lside = { 1d / 6, 1d / 6, 0, 2d / 6, 0, 2d / 6, 0, 0 };

    //How likely am I to hit a certain location with a punch, given what direction the fire is coming from
    //Order is: LOC_HEAD,LOC_CT,LOC_RT,LOC_LT,LOC_RARM,LOC_LARM,LOC_RLEG,LOC_LLEG Defined in megamek.common.Mech
    public static final double[] hit_probabilities_kick_front = { 0, 0, 0, 0, 0, 0, 3d / 6, 3d / 6 };
    public static final double[] hit_probabilities_kick_rside = { 0, 0, 0, 0, 0, 0, 1d, 0 };
    public static final double[] hit_probabilities_kick_lside = { 0, 0, 0, 0, 0, 0, 0, 1d };
