...
/**
 * A commander node gives the rank to assign the force's commander, an optional title, and the position within the force
 * structure (typically in the first unit/subforce for a field officer).
 *
 * @author Neoancient
 */
