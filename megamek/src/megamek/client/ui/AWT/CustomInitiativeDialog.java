...
public class CustomInitiativeDialog extends Dialog implements ActionListener, WindowListener {
    ...
    private Label m_labRoundTitle = new Label(Messages.getString("CustomInitiativeDialog.RoundTitle"));
    private Label m_labConstant = new Label(Messages.getString("CustomInitiativeDialog.ConstantBonus"));
