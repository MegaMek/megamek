 ...
 * Vehicles &amp; Fieldworks). Creates and removes {@link FortifyBuildSprite} instances on the hexes of all units that
 * are currently building a fortified hex; the build state is read from the synced entities.
 */
