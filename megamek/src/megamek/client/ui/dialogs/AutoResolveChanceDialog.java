...
public class AutoResolveChanceDialog extends AbstractDialog implements PropertyChangeListener {
    ...
    public static int showDialog(JFrame frame, int numberOfSimulations, int numberOfThreads, int currentTeam,
          SetupForces setupForces, Board board) {
        var dialog = new AutoResolveChanceDialog(frame,
              numberOfSimulations,
              numberOfThreads,
              currentTeam,
              setupForces,
    ...
    private class Task extends SwingWorker<Integer, Integer> {
        ...
        public Integer doInBackground() {
            ...
            var code = JOptionPane.showConfirmDialog(getFrame(),
                  message,
                  title,
            ...
            try {
                ...
                for (int i = 0; i < numberOfSimulations; i++) {
                    futures.add(executor.submit(() -> {
                        var autoResolveConcludedEvent = Resolver.simulationRunWithoutLog(setupForces,
