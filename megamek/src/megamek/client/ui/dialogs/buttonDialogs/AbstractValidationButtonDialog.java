 ...
 * <p>
 * This is directly tied to MekHQ's AbstractMHQValidationButtonDialog, and any changes here MUST be verified there.
 */
public abstract class AbstractValidationButtonDialog extends AbstractButtonDialog {
    ...
    /**
     * This creates an AbstractValidationButtonDialog using the default resource bundle. It allows one to create
     * non-modal button dialogs.
     */
    ...
    /**
     * This creates an AbstractValidationButtonDialog using the specified resource bundle. This is not recommended by
     * default.
     */
    protected AbstractValidationButtonDialog(final JFrame frame, final boolean modal,
    ...
    /**
     * This is the default Action Event Listener for the Ok Button's action. It performs data validation, then only
     * triggers the AbstractButtonDialog's Ok Button's action if the data was successfully validated
     *
    ...
    /**
     * This performs data validation on the dialog if the current validation state is pending or warning, or if this is
     * manually triggered.
     *
     * @param evt the event triggering this, or null if you want to put the output into a popup, if applicable
     */
