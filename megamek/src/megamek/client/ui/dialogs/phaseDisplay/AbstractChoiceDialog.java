...
public abstract class AbstractChoiceDialog<T> extends AbstractButtonDialog {
    ...
    /**
     * This creates a modal AbstractChoiceDialog using the default resource bundle as a Modal dialog. concrete classes
     * must call initialize() at the end of the constructor
     *
    ...
    /**
     * Override to set button text and/or icon with details about this choice. Usually this is called then the show
     * details button is depressed
     *
    ...
    /**
     * Override to set button text and/or icon with summary info about this choice. This is called then the show details
