...
public class RandomMapPanelAdvancedPanel extends JPanel {
        ...
        private final VerifiableTextField fireChanceField = new VerifiableTextField(4, true, true,
                        new VerifyInRange(0, 100, true));
        private final VerifiableTextField specialFxField = new VerifiableTextField(4, true, true,
                        new VerifyIsInteger());
        ...
        private JPanel setupRubblePanel() {
                ...
                rubbleUltraChanceField
                                .setToolTipText(Messages.getString("RandomMapDialog.rubbleUltraChanceField.toolTip"));
        ...
        private JPanel setupFortifiedPanel() {
                ...
                fortifiedSizeMinField
                                .setToolTipText(Messages.getString("RandomMapDialog.fortifiedSizeMinField.toolTip"));
                ...
                fortifiedSizeMaxField
                                .setToolTipText(Messages.getString("RandomMapDialog.fortifiedSizeMaxField.toolTip"));
        ...
        private JPanel setupWoodsPanel() {
                ...
                woodsHeavyChanceField
                                .setToolTipText(Messages.getString("RandomMapDialog.woodsHeavyChanceField.toolTip"));
                ...
                woodsUltraChanceField
                                .setToolTipText(Messages.getString("RandomMapDialog.woodsUltraChanceField.toolTip"));
        ...
        private JPanel setupJunglePanel() {
                ...
                jungleHeavyChanceField
                                .setToolTipText(Messages.getString("RandomMapDialog.jungleHeavyChanceField.toolTip"));
                ...
                jungleUltraChanceField
                                .setToolTipText(Messages.getString("RandomMapDialog.jungleUltraChanceField.toolTip"));
        ...
        private JPanel setupFoliagePanel() {
                ...
                foliageHeavyChanceField
                                .setToolTipText(Messages.getString("RandomMapDialog.foliageHeavyChanceField.toolTip"));
        ...
        private JPanel setupRoughsPanel() {
                ...
                roughsUltraChanceField
                                .setToolTipText(Messages.getString("RandomMapDialog.roughsUltraChanceField.toolTip"));
        ...
        private JPanel setupMountainsPanel() {
                ...
                mountainHeightMinField
                                .setToolTipText(Messages.getString("RandomMapDialog.mountainHeightMinField.toolTip"));
                ...
                mountainHeightMaxField
                                .setToolTipText(Messages.getString("RandomMapDialog.mountainHeightMaxField.toolTip"));
                ...
                mountainWidthMinField
                                .setToolTipText(Messages.getString("RandomMapDialog.mountainWidthMinField.toolTip"));
                ...
                mountainWidthMaxField
                                .setToolTipText(Messages.getString("RandomMapDialog.mountainWidthMaxField.toolTip"));
        ...
        private JPanel setupElevationGeneralPanel() {
                ...
                elevationAlgorithmField
                                .setToolTipText(Messages.getString("RandomMapDialog.elevationAlgorithmField.toolTip"));
                ...
                elevationInversionField
                                .setToolTipText(Messages.getString("RandomMapDialog.elevationInversionField.toolTip"));
        ...
        private enum MountainStyle {
                ...
                VOLCANO_EXTINCT(MapSettings.MOUNTAIN_VOLCANO_EXTINCT,
                                Messages.getString("RandomMapDialog.volcanoExtinct")),
                VOLCANO_DORMANT(MapSettings.MOUNTAIN_VOLCANO_DORMANT,
