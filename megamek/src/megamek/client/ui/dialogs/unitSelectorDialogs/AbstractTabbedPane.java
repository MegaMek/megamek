...
public abstract class AbstractTabbedPane extends JTabbedPane {
    ...
    /**
     * This initializes the tabbed pane, and must be called by inheriting constructors. This MUST end with a call to
     ...
     * <p>
     * By default, this pane will track preferences related to the previously selected tab. Other preferences can be
