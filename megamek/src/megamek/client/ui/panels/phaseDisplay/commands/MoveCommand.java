...
public enum MoveCommand implements StatusBarPhaseDisplay.PhaseCommand {
    ...
    MOVE_MOUNT("moveMount", MovementDisplay.CMD_GROUND | MovementDisplay.CMD_AERO_BOTH),
    MOVE_TOW("moveTow", MovementDisplay.CMD_TANK),
    MOVE_DISCONNECT("moveDisconnect", MovementDisplay.CMD_TANK),
    MOVE_MODULE_LINK("moveModuleLink", MovementDisplay.CMD_GROUND),
    MOVE_MODULE_UNLINK("moveModuleUnlink", MovementDisplay.CMD_GROUND),
    ...
    MOVE_LAUNCH("MoveLaunch", MovementDisplay.CMD_AERO_BOTH | MovementDisplay.CMD_MOBILE),
    ...
    MOVE_HOVER("MoveHover", MovementDisplay.CMD_AERO | MovementDisplay.CMD_AIR_MEK | MovementDisplay.CMD_MOBILE),
    ...
    MOVE_VERT_TAKE_OFF("MoveVertTakeOff", MovementDisplay.CMD_TANK | MovementDisplay.CMD_MOBILE),
    MOVE_LAND("MoveLand", MovementDisplay.CMD_AERO_BOTH),
    MOVE_VERT_LAND("MoveVLand", MovementDisplay.CMD_AERO_BOTH | MovementDisplay.CMD_MOBILE),
