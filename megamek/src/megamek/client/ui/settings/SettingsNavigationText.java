...
/** Resolved text used by {@link SettingsNavigationPanel}. */
public record SettingsNavigationText(
    ...
    public SettingsNavigationText {
        ...
        Objects.requireNonNull(filterTooltip);
        Objects.requireNonNull(noMatches);
