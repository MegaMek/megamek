...
/** A localized, consistently styled text field for settings forms. */
public class SettingsTextField extends JTextField implements SettingsHelpProvider {
    private final String settingsHelpText;

    public SettingsTextField(SettingsTextProvider textProvider, String keyBase) {
        this(textProvider, keyBase, null);
    }

    public SettingsTextField(SettingsTextProvider textProvider, String keyBase, @Nullable Integer tooltipWrapSize) {
