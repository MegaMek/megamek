...
/**
 * A dialog to determine which artillery weapons in a bay should fire on the target hex.
 *
 * @author MKerensky
 */
public class ArtilleryBayWeaponDialog extends JDialog implements ActionListener, ItemListener {
    /**
     * 
     */
