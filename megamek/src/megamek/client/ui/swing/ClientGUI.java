...
public class ClientGUI extends JPanel implements WindowListener, BoardViewListener, ActionListener, ComponentListener {
    ...
    public void doSaveUnit() {
        for (Enumeration<IPlayer> iter = getClient().getGame().getPlayers(); iter.hasMoreElements(); ) {
            ...
            List<Entity> l = getClient().getGame().getPlayerEntities(p, false);
    ...
    public void deleteAllUnits(Client c) {
        List<Entity> currentUnits = c.getGame().getPlayerEntities(c.getLocalPlayer(), false);
        List<Integer> ids = new ArrayList<>(currentUnits.size());
    ...
    private GameListener gameListener = new GameListenerAdapter() {
        ...
        public void gameEnd(GameEndEvent e) {
            ...
            List<Entity> living = getClient().getGame().getPlayerEntities(getClient().getLocalPlayer(), false);
