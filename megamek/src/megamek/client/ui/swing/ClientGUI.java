            ...
            switch (evt.getCFRType()) {
                case CFR_DOMINO_EFFECT:
                    ...
                    if (stepForward.isMoveLegal() && stepBackward.isMoveLegal()) {
                        ...
                        options[0] = Messages.getFormattedString("CFRDomino.Forward", stepForward.getMpUsed());
                        options[1] = Messages.getFormattedString("CFRDomino.Backward", stepForward.getMpUsed());
                        ...
                        options = new Object[2];
                        paths = new MovePath[2];
                        options[0] = Messages.getFormattedString("CFRDomino.Backward", stepForward.getMpUsed());
                        options[1] = Messages.getString("CFRDomino.NoAction");
                ...
                case CFR_AMS_ASSIGN:
                    ...
                    result = JOptionPane.showInputDialog(frame,
                            Messages.getFormattedString("CFRAMSAssign.Message", e.getDisplayName()),
                            Messages.getFormattedString("CFRAMSAssign.Title", e.getDisplayName()),
                ...
                case CFR_APDS_ASSIGN:
                    ...
                    result = JOptionPane.showInputDialog(frame,
                            Messages.getFormattedString("CFRAPDSAssign.Message", e.getDisplayName()),
                            Messages.getFormattedString("CFRAPDSAssign.Title", e.getDisplayName()),
                ...
                case CFR_HIDDEN_PBS:
                    ...
                    int pbsChoice = JOptionPane.showConfirmDialog(frame,
                            Messages.getFormattedString("ClientGUI.PointBlankShot.Message",
