...
public class UtilityAiEditor extends JPanel implements ItemListener, ListSelectionListener, ActionListener,
        DocumentListener, IMapSettingsObserver {
    private final static MMLogger logger = MMLogger.create(UtilityAiEditor.class);
     ...
     */
    public UtilityAiEditor(MegaMekController c) {
        controller = c;
        try {
