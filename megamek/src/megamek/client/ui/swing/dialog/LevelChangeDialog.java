 ...
 */ 
public class LevelChangeDialog extends AbstractButtonDialog {
    
    BoardEditor.EditorTextField txtLevelChange = new BoardEditor.EditorTextField("1", 5, -5, 15);
    JLabel labInfo = new JLabel(UIUtil.scaleStringForGUI(Messages.getString("LCDialog.info")), SwingConstants.CENTER);
    ...
    protected Container createCenterPane() {
        ...
        JPanel textFieldPanel = new UIUtil.FixedYPanel();
