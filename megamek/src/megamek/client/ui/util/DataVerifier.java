...
public interface DataVerifier {
    ...
    /**
     * Performs a verification of the given value. If the value is good, a null is returned. Otherwise, a {@link String}
     * explaining how the verification failed will be returned.
     *
