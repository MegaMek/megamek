...
public class MekMapSet implements DisplayMapSet {
    ...
    private void setAreas() {
        ...
        areas[INT_STRUCTURE_OFFSET + Mek.LOC_CT] = new PMSimplePolygonArea(inStCentralTorso, unitDisplayPanel, Mek.LOC_CT);
        areas[INT_STRUCTURE_OFFSET + Mek.LOC_RT] = new PMSimplePolygonArea(inStRightTorso, unitDisplayPanel, Mek.LOC_RT);
        areas[INT_STRUCTURE_OFFSET + Mek.LOC_LT] = new PMSimplePolygonArea(inStLeftTorso, unitDisplayPanel, Mek.LOC_LT);
        areas[INT_STRUCTURE_OFFSET + Mek.LOC_RARM] = new PMSimplePolygonArea(inStRightArm, unitDisplayPanel, Mek.LOC_RARM);
        areas[INT_STRUCTURE_OFFSET + Mek.LOC_LARM] = new PMSimplePolygonArea(inStLeftArm, unitDisplayPanel, Mek.LOC_LARM);
        areas[INT_STRUCTURE_OFFSET + Mek.LOC_RLEG] = new PMSimplePolygonArea(inStRightLeg, unitDisplayPanel, Mek.LOC_RLEG);
        areas[INT_STRUCTURE_OFFSET + Mek.LOC_LLEG] = new PMSimplePolygonArea(inStLeftLeg, unitDisplayPanel, Mek.LOC_LLEG);
