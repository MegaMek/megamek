...
public class AeroMapSet implements DisplayMapSet {
    ...
    private void setLabels() {
        ...
        labels[Aero.LOC_LEFT_WING] = WidgetUtils.createLabel("LWG", fm, Color.black, 32, 120);
        //    labels[Aero.LOC_LEFT_WING + INT_STR_OFFSET] = WidgetUtils.createLabel(Messages.getString("TankMapSet.LIS"), fm, Color.black, 10, 106);
        labels[Aero.LOC_RIGHT_WING] = WidgetUtils.createLabel("RWG", fm, Color.black, 92, 120);
        ...
        vLabels[Aero.LOC_LEFT_WING] = WidgetUtils.createValueLabel(32, 135, "", fm);
        //   vLabels[Aero.LOC_LEFT_WING + INT_STR_OFFSET] = WidgetUtils.createValueLabel(10, 100, "", fm);
        vLabels[Aero.LOC_RIGHT_WING] = WidgetUtils.createValueLabel(92, 135, "", fm);
