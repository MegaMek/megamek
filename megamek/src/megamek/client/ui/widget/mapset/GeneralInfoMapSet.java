...
public class GeneralInfoMapSet implements DisplayMapSet {
    ...
    private PMSimpleLabel mekTypeL0;
    ...
    public void setEntity(Entity en) {
        ...
        heatR.setColor(GUIP.getColorForHeat(en.heat, Color.WHITE));
    ...
    private void setBackGround() {
        ...
        tile = jComponent.getToolkit().getImage(new MegaMekFile(Configuration.widgetsDir(),
