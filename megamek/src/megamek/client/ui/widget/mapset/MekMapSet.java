...
public class MekMapSet implements DisplayMapSet {
    ...
    private void setAreas() {
        ...
        areas[REAR_AREA_OFFSET + Mek.LOC_CT] = new PMSimplePolygonArea(rearCentralTorso, unitDisplayPanel, Mek.LOC_CT);
        areas[REAR_AREA_OFFSET + Mek.LOC_RT] = new PMSimplePolygonArea(rearRightTorso, unitDisplayPanel, Mek.LOC_RT);
        areas[REAR_AREA_OFFSET + Mek.LOC_LT] = new PMSimplePolygonArea(rearLeftTorso, unitDisplayPanel, Mek.LOC_LT);
        areas[INT_STRUCTURE_OFFSET + Mek.LOC_HEAD] = new PMSimplePolygonArea(intStHead, unitDisplayPanel, Mek.LOC_HEAD);
        areas[INT_STRUCTURE_OFFSET + Mek.LOC_CT] = new PMSimplePolygonArea(inStCentralTorso,
              unitDisplayPanel,
              Mek.LOC_CT);
        areas[INT_STRUCTURE_OFFSET + Mek.LOC_RT] = new PMSimplePolygonArea(inStRightTorso,
              unitDisplayPanel,
              Mek.LOC_RT);
        areas[INT_STRUCTURE_OFFSET + Mek.LOC_LT] = new PMSimplePolygonArea(inStLeftTorso, unitDisplayPanel, Mek.LOC_LT);
        areas[INT_STRUCTURE_OFFSET + Mek.LOC_RARM] = new PMSimplePolygonArea(inStRightArm,
              unitDisplayPanel,
              Mek.LOC_RARM);
        areas[INT_STRUCTURE_OFFSET + Mek.LOC_LARM] = new PMSimplePolygonArea(inStLeftArm,
              unitDisplayPanel,
              Mek.LOC_LARM);
        areas[INT_STRUCTURE_OFFSET + Mek.LOC_RLEG] = new PMSimplePolygonArea(inStRightLeg,
              unitDisplayPanel,
              Mek.LOC_RLEG);
        areas[INT_STRUCTURE_OFFSET + Mek.LOC_LLEG] = new PMSimplePolygonArea(inStLeftLeg,
              unitDisplayPanel,
              Mek.LOC_LLEG);
    ...
    private void setLabels() {
        ...
        labels[INT_STRUCTURE_OFFSET + Mek.LOC_LARM] = WidgetUtils.createLabel(Messages.getString("MekMapSet.l_LA"),
        ...
        labels[INT_STRUCTURE_OFFSET + Mek.LOC_RARM] = WidgetUtils.createLabel(Messages.getString("MekMapSet.L_RA"),
              fm, Color.black, 111, 174);
        labels[INT_STRUCTURE_OFFSET + Mek.LOC_LLEG] = WidgetUtils.createLabel(Messages.getString("MekMapSet.l_LL"),
              fm, Color.black, 33, 210);
        labels[INT_STRUCTURE_OFFSET + Mek.LOC_RLEG] = WidgetUtils.createLabel(Messages.getString("MekMapSet.l_RL"),
