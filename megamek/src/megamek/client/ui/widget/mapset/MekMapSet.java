...
public class MekMapSet implements DisplayMapSet {
    ...
    public MekMapSet(JComponent c, LocationSelectListener locationSelectListener) {
    ...
    private void setAreas() {
        ...
        areas[REAR_AREA_OFFSET + Mek.LOC_LEFT_TORSO] = new PMSimplePolygonArea(rearLeftTorso,
              locationSelectListener,
              Mek.LOC_LEFT_TORSO);
        areas[INT_STRUCTURE_OFFSET + Mek.LOC_HEAD] = new PMSimplePolygonArea(intStHead, locationSelectListener, Mek.LOC_HEAD);
