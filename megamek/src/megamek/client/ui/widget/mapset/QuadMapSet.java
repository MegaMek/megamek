...
public class QuadMapSet implements DisplayMapSet {
    ...
    private void setLabels() {
        ...
        labels[Mek.LOC_LEFT_ARM] = WidgetUtils.createLabel(Messages.getString("QuadMapSet.L_LA"),
        ...
        labels[Mek.LOC_RIGHT_ARM] = WidgetUtils.createLabel(Messages.getString("QuadMapSet.L_RA"),
              fm, Color.black, 111, 69);
        labels[Mek.LOC_LEFT_LEG] = WidgetUtils.createLabel(Messages.getString("QuadMapSet.L_LL"),
              fm, Color.black, 39, 87);
        labels[Mek.LOC_RIGHT_LEG] = WidgetUtils.createLabel(Messages.getString("QuadMapSet.L_RL"),
        ...
        labels[INT_STRUCTURE_OFFSET + Mek.LOC_LEFT_ARM] = WidgetUtils.createLabel(Messages.getString("QuadMapSet.L_LA"),
        ...
        labels[INT_STRUCTURE_OFFSET
              + Mek.LOC_RIGHT_ARM] = WidgetUtils.createLabel(Messages.getString("QuadMapSet.L_RA"),
              fm, Color.black, 111, 179);
        labels[INT_STRUCTURE_OFFSET + Mek.LOC_LEFT_LEG] = WidgetUtils.createLabel(Messages.getString("QuadMapSet.L_LL"),
              fm, Color.black, 39, 200);
        labels[INT_STRUCTURE_OFFSET
              + Mek.LOC_RIGHT_LEG] = WidgetUtils.createLabel(Messages.getString("QuadMapSet.L_RL"),
        ...
        vLabels[Mek.LOC_LEFT_ARM] = WidgetUtils.createValueLabel(13, 82, "", fm);
        vLabels[Mek.LOC_LEFT_TORSO] = WidgetUtils.createValueLabel(40, 66, "", fm);
        vLabels[Mek.LOC_CENTER_TORSO] = WidgetUtils.createValueLabel(62, 60, "", fm);
        vLabels[Mek.LOC_RIGHT_TORSO] = WidgetUtils.createValueLabel(85, 66, "", fm);
        vLabels[Mek.LOC_RIGHT_ARM] = WidgetUtils.createValueLabel(112, 82, "", fm);
        vLabels[Mek.LOC_LEFT_LEG] = WidgetUtils.createValueLabel(39, 103, "", fm);
        vLabels[Mek.LOC_RIGHT_LEG] = WidgetUtils.createValueLabel(85, 103, "", fm);
        ...
        vLabels[INT_STRUCTURE_OFFSET + Mek.LOC_LEFT_ARM] = WidgetUtils.createValueLabel(15, 192, "", fm);
        vLabels[INT_STRUCTURE_OFFSET + Mek.LOC_LEFT_TORSO] = WidgetUtils.createValueLabel(42, 180, "", fm);
        vLabels[INT_STRUCTURE_OFFSET + Mek.LOC_CENTER_TORSO] = WidgetUtils.createValueLabel(63, 175, "", fm);
        vLabels[INT_STRUCTURE_OFFSET + Mek.LOC_RIGHT_TORSO] = WidgetUtils.createValueLabel(85, 180, "", fm);
        vLabels[INT_STRUCTURE_OFFSET + Mek.LOC_RIGHT_ARM] = WidgetUtils.createValueLabel(111, 192, "", fm);
        vLabels[INT_STRUCTURE_OFFSET + Mek.LOC_LEFT_LEG] = WidgetUtils.createValueLabel(39, 215, "", fm);
        vLabels[INT_STRUCTURE_OFFSET + Mek.LOC_RIGHT_LEG] = WidgetUtils.createValueLabel(85, 215, "", fm);
