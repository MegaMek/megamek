...
public class SpheroidMapSet implements DisplayMapSet {
    ...
    //Left armor
    private final Polygon leftWingArmor = new Polygon(
          new int[] { 0, 40, 40, 0 },
          new int[] { 50, 50, 150, 150 }, 4);

    //Right armor
    private final Polygon rightWingArmor = new Polygon(
          new int[] { 60, 100, 100, 60 },
          new int[] { 50, 50, 150, 150 }, 4);
    ...
    public SpheroidMapSet(JComponent c, LocationSelectListener locationSelectListener) {
