...
public class TripodMekMapSet implements DisplayMapSet {
    ...
    private final PMSimplePolygonArea[] areas = new PMSimplePolygonArea[21];
    // Array of fixed labels - short names of body parts
    private final PMSimpleLabel[] labels = new PMSimpleLabel[22];
    // Array of value labels to show armor and IS values
    private final PMValueLabel[] vLabels = new PMValueLabel[23];
    // Heat control area
    ...
    private final Polygon centerLeg = new Polygon(
          new int[] { 49, 49, 75, 75, 64, 61 },
    ...
    private final Polygon inStCenterLeg = new Polygon(
          new int[] { 53, 53, 74, 74 },
          new int[] { 203, 230, 230, 203 }, 4);
    ...
    public TripodMekMapSet(JComponent c, LocationSelectListener locationSelectListener) {
    ...
    private void setAreas() {
        ...
        areas[Mek.LOC_CENTER_LEG] = new PMSimplePolygonArea(centerLeg, locationSelectListener, Mek.LOC_CENTER_LEG);
        ...
        areas[INT_STRUCTURE_OFFSET + Mek.LOC_CENTER_LEG] = new PMSimplePolygonArea(
              inStCenterLeg, locationSelectListener, Mek.LOC_CENTER_LEG);
    ...
    private void setLabels() {
        ...
        labels[Mek.LOC_CENTER_LEG] = WidgetUtils.createLabel(Messages.getString("MekMapSet.l_CL"),
        ...
        labels[INT_STRUCTURE_OFFSET + Mek.LOC_LEFT_ARM] = WidgetUtils.createLabel(
        ...
        labels[INT_STRUCTURE_OFFSET + Mek.LOC_RIGHT_ARM] = WidgetUtils.createLabel(
        ...
        labels[INT_STRUCTURE_OFFSET + Mek.LOC_CENTER_LEG] = WidgetUtils.createLabel(
        ...
        vLabels[Mek.LOC_CENTER_LEG] = WidgetUtils.createValueLabel(62, 113, "", fm);
        ...
        vLabels[INT_STRUCTURE_OFFSET + Mek.LOC_CENTER_LEG] = WidgetUtils.createValueLabel(62, 223, "", fm);
        // heat
