...
public class WarshipMapSet implements DisplayMapSet {
    ...
    private final Polygon structure = new Polygon(
          new int[] { 35, 65, 65, 35 },
          new int[] { 50, 50, 150, 150 }, 4);
    //Left front armor
    private final Polygon leftFSArmor = new Polygon(
          new int[] { 0, 35, 35, 0 },
          new int[] { 50, 50, 110, 110 }, 4);
    //Left aft armor
    private final Polygon leftASArmor = new Polygon(
          new int[] { 0, 35, 35, 0 },
          new int[] { 110, 110, 150, 150 }, 4);

    private final Polygon rightFSArmor = new Polygon(
          new int[] { 65, 100, 100, 65 },
          new int[] { 50, 50, 110, 110 }, 4);
    //right aft armor
    private final Polygon rightASArmor = new Polygon(
          new int[] { 65, 100, 100, 65 },
          new int[] { 110, 110, 150, 150 }, 4);

    //Rear armor
    private final Polygon aftArmor = new Polygon(
          new int[] { 0, -10, 40, 40, 60, 60, 110, 100 },
    ...
    public WarshipMapSet(JComponent c, LocationSelectListener locationSelectListener) {
