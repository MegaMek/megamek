...
public class AmmoType extends EquipmentType {
    ...
    public static void initializeTypes() {
        ...
        munitions.add(new MunitionMutator("Thunder-Augmented", 1, M_THUNDER_AUGMENTED, TechConstants.T_IS_ADVANCED));
        munitions.add(new MunitionMutator("Thunder-Inferno", 1, M_THUNDER_INFERNO, TechConstants.T_IS_ADVANCED));
        munitions.add(new MunitionMutator("Thunder-Active", 1, M_THUNDER_ACTIVE, TechConstants.T_IS_ADVANCED));
        munitions.add(new MunitionMutator("Thunder-Vibrabomb", 1, M_THUNDER_VIBRABOMB, TechConstants.T_IS_ADVANCED));
        munitions.add(new MunitionMutator("Narc-capable", 1, M_NARC_CAPABLE, TechConstants.T_IS_TW_NON_BOX));
        munitions.add(new MunitionMutator("Artemis-capable", 1, M_ARTEMIS_CAPABLE, TechConstants.T_IS_TW_NON_BOX));
        ...
        munitions.add(new MunitionMutator("(Clan) Thunder-Augmented", 1, M_THUNDER_AUGMENTED, TechConstants.T_CLAN_ADVANCED));
        munitions.add(new MunitionMutator("(Clan) Thunder-Inferno", 1, M_THUNDER_INFERNO, TechConstants.T_CLAN_ADVANCED));
        munitions.add(new MunitionMutator("(Clan) Thunder-Active", 1, M_THUNDER_ACTIVE, TechConstants.T_CLAN_ADVANCED));
        munitions.add(new MunitionMutator("(Clan) Thunder-Vibrabomb", 1, M_THUNDER_VIBRABOMB, TechConstants.T_CLAN_ADVANCED));
        munitions.add(new MunitionMutator("(Clan) Narc-capable", 1, M_NARC_CAPABLE, TechConstants.T_CLAN_TW));
        munitions.add(new MunitionMutator("(Clan) Artemis-capable", 1, M_ARTEMIS_CAPABLE, TechConstants.T_CLAN_TW));
        munitions.add(new MunitionMutator("(Clan) Artemis V-capable", 1, M_ARTEMIS_V_CAPABLE, TechConstants.T_CLAN_EXPERIMENTAL));
        ...
        munitions.add(new MunitionMutator("Inferno-IV", 1, M_INFERNO_IV, TechConstants.T_CLAN_ADVANCED));
        munitions.add(new MunitionMutator("Vibrabomb-IV", 1, M_VIBRABOMB_IV, TechConstants.T_CLAN_ADVANCED));
