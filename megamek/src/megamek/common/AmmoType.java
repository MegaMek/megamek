...
public class AmmoType extends EquipmentType {
    ...
    public enum AmmoTypeEnum {
        NA(-1, "N/A", AmmoCategory.Special, false),
        AC(1, "Autocannon", AmmoCategory.Ballistic, false),
        VEHICLE_FLAMER(2, "Vehicle Flamer", AmmoCategory.Chemical, false),
        MG(3, "Machine Gun", AmmoCategory.Ballistic, false),
        MG_HEAVY(4, "Heavy Machine Gun", AmmoCategory.Ballistic, false),
        MG_LIGHT(5, "Light Machine Gun", AmmoCategory.Ballistic, false),
        GAUSS(6, "Gauss Rifle", AmmoCategory.Ballistic, false),
        LRM(7, "Long Range Missile", AmmoCategory.Missile, true),
        LRM_TORPEDO(8, "LRM Torpedo", AmmoCategory.Missile, true),
        SRM(9, "Short Range Missile", AmmoCategory.Missile, true),
        SRM_TORPEDO(10, "SRM Torpedo", AmmoCategory.Missile, true),
        SRM_STREAK(11, "Streak SRM", AmmoCategory.Missile, true),
        ...
        AC_LBX(19, "LB-X Autocannon", AmmoCategory.Ballistic, false),
        AC_ULTRA(20, "Ultra Autocannon", AmmoCategory.Ballistic, false),
        GAUSS_LIGHT(21, "Light Gauss Rifle", AmmoCategory.Ballistic, false),
        GAUSS_HEAVY(22, "Heavy Gauss Rifle", AmmoCategory.Ballistic, false),
        AC_ROTARY(23, "Rotary Autocannon", AmmoCategory.Ballistic, false),
        SRM_ADVANCED(24, "Advanced SRM", AmmoCategory.Missile, true),
        BA_MICRO_BOMB(25, "BA Micro Bomb", AmmoCategory.Bomb, false),
        LRM_TORPEDO_COMBO(26, "LRM Torpedo Combo", AmmoCategory.Missile, true),
        MINE(27, "Mine", AmmoCategory.Special, false),
        ATM(28, "Advanced Tactical Missile", AmmoCategory.Missile, true),
        ROCKET_LAUNCHER(29, "Rocket Launcher", AmmoCategory.Missile, true),
        INARC(30, "iNARC", AmmoCategory.Special, false),
        LRM_STREAK(31, "Streak LRM", AmmoCategory.Missile, true),
        AC_LBX_THB(32, "LB-X Autocannon THB", AmmoCategory.Ballistic, false),
        AC_ULTRA_THB(33, "Ultra Autocannon THB", AmmoCategory.Ballistic, false),
        LAC(34, "Light Autocannon", AmmoCategory.Ballistic, false),
        HEAVY_FLAMER(35, "Heavy Flamer", AmmoCategory.Chemical, false),
        COOLANT_POD(36, "Coolant Pod", AmmoCategory.Special, false),
        EXLRM(37, "Extended LRM", AmmoCategory.Missile, true),
        APGAUSS(38, "AP Gauss Rifle", AmmoCategory.Ballistic, false),
        MAGSHOT(39, "MagShot Gauss Rifle", AmmoCategory.Ballistic, false),
        // PXLRM(40, "Prototype Extended LRM", AmmoCategory.Missile, true),
        // HSRM(41, "Heavy SRM", AmmoCategory.Missile, true),
        // MRM_STREAK(42, "Streak Medium Range Missile", AmmoCategory.Missile, true),
        MPOD(43, "M-Pod", AmmoCategory.Special, false),
        HAG(44, "Hyper Assault Gauss", AmmoCategory.Ballistic, false),
        MML(45, "Multi-Missile Launcher", AmmoCategory.Missile, true),
        PLASMA(46, "Plasma Rifle", AmmoCategory.Energy, false),
        SBGAUSS(47, "Silver Bullet Gauss", AmmoCategory.Ballistic, false),
        RAIL_GUN(48, "Rail Gun", AmmoCategory.Ballistic, false),
        TBOLT_5(49, "Thunderbolt 5", AmmoCategory.Missile, false),
        TBOLT_10(50, "Thunderbolt 10", AmmoCategory.Missile, false),
        TBOLT_15(51, "Thunderbolt 15", AmmoCategory.Missile, false),
        TBOLT_20(52, "Thunderbolt 20", AmmoCategory.Missile, false),
        NAC(53, "Naval Autocannon", AmmoCategory.Ballistic, false),
        LIGHT_NGAUSS(54, "Light Naval Gauss", AmmoCategory.Ballistic, false),
        MED_NGAUSS(55, "Medium Naval Gauss", AmmoCategory.Ballistic, false),
        HEAVY_NGAUSS(56, "Heavy Naval Gauss", AmmoCategory.Ballistic, false),
        KILLER_WHALE(57, "Killer Whale", AmmoCategory.Missile, false),
        WHITE_SHARK(58, "White Shark", AmmoCategory.Missile, false),
        BARRACUDA(59, "Barracuda", AmmoCategory.Missile, false),
        KRAKEN_T(60, "Kraken-T", AmmoCategory.Missile, false),
        AR10(61, "AR10", AmmoCategory.Missile, false),
        SCREEN_LAUNCHER(62, "Screen Launcher", AmmoCategory.Special, false),
        ALAMO(63, "Alamo", AmmoCategory.Missile, false),
        IGAUSS_HEAVY(64, "Heavy iGauss", AmmoCategory.Ballistic, false),
        CHEMICAL_LASER(65, "Chemical Laser", AmmoCategory.Energy, false),
        HYPER_VELOCITY(66, "Hyper Velocity AC", AmmoCategory.Ballistic, false),
        MEK_MORTAR(67, "Mek Mortar", AmmoCategory.Artillery, false),
        CRUISE_MISSILE(68, "Cruise Missile", AmmoCategory.Missile, false),
        BPOD(69, "B-Pod", AmmoCategory.Special, false),
        SCC(70, "Sub-Capital Cannon", AmmoCategory.Ballistic, false),
        MANTA_RAY(71, "Manta Ray", AmmoCategory.Missile, false),
        SWORDFISH(72, "Swordfish", AmmoCategory.Missile, false),
        STINGRAY(73, "Stingray", AmmoCategory.Missile, false),
        PIRANHA(74, "Piranha", AmmoCategory.Missile, false),
        TASER(75, "Taser", AmmoCategory.Special, false),
        BOMB(76, "Bomb", AmmoCategory.Bomb, false),
        AAA_MISSILE(77, "AAA Missile", AmmoCategory.Missile, true),
        AS_MISSILE(78, "AS Missile", AmmoCategory.Missile, true),
        ASEW_MISSILE(79, "ASEW Missile", AmmoCategory.Missile, true),
        LAA_MISSILE(80, "LAA Missile", AmmoCategory.Missile, true),
        RL_BOMB(81, "RL Bomb", AmmoCategory.Bomb, false),
        ARROW_IV_BOMB(82, "Arrow IV Bomb", AmmoCategory.Bomb, false),
        FLUID_GUN(83, "Fluid Gun", AmmoCategory.Chemical, false),
        SNIPER_CANNON(84, "Sniper Cannon", AmmoCategory.Artillery, false),
        THUMPER_CANNON(85, "Thumper Cannon", AmmoCategory.Artillery, false),
        LONG_TOM_CANNON(86, "Long Tom Cannon", AmmoCategory.Artillery, false),
        ...
        C3_REMOTE_SENSOR(94, "C3 Remote Sensor", AmmoCategory.Special, false),
        AC_PRIMITIVE(95, "Primitive Autocannon", AmmoCategory.Ballistic, false),
        LRM_PRIMITIVE(96, "Primitive LRM", AmmoCategory.Missile, true),
        SRM_PRIMITIVE(97, "Primitive SRM", AmmoCategory.Missile, true),
        BA_TUBE(98, "BA Tube Artillery", AmmoCategory.Artillery, false),
        IATM(99, "Improved ATM", AmmoCategory.Missile, true),
        LMASS(100, "Light Mass Driver", AmmoCategory.Ballistic, false),
        MMASS(101, "Medium Mass Driver", AmmoCategory.Ballistic, false),
        HMASS(102, "Heavy Mass Driver", AmmoCategory.Ballistic, false),
        APDS(103, "APDS", AmmoCategory.Ballistic, false),
        AC_IMP(104, "Improved Autocannon", AmmoCategory.Ballistic, false),
        GAUSS_IMP(105, "Improved Gauss", AmmoCategory.Ballistic, false),
        ...
        INFANTRY(113, "Infantry", AmmoCategory.Special, false);
        ...
        private final boolean canBeInterceptedByAMS;

        AmmoTypeEnum(int index, String name, AmmoCategory category, boolean canBeInterceptedByAMS) {
            this.index = index;
            this.name = name;
            this.category = category;
            this.canBeInterceptedByAMS = canBeInterceptedByAMS;
        }
    ...
    public boolean isAffectedByAMS() {
        ...
        if (this.getAmmoType().canBeInterceptedByAMS()) {
            affected = true;
        }
        if (affected && this.getMunitionType().contains(Munitions.M_ADA)) {
            // ADA minutions are not affected by AMS as they are for counter-artillery
            affected = false;
        }
        return affected;
    }
