...
public interface BTObject {
    ...
    /**
     * Returns true when this object is a Quad Mek or QuadVee, regardless of
     * conversion state.
     * Returns false for any type of unit group even if it consists only of Quad
     * Meks.
     *
    ...
    /**
     * Returns true when this object is an Industrial Mek or of type IM for Alpha
     * Strike.
     * Returns false for any type of unit group even if it is of the right type.
     *
    ...
    /**
     * Returns true when this object is a Fixed-Wing Support or of type SV(MV a) for
     * Alpha Strike.
     * Returns false for any type of unit group even if it is of the right type.
     *
    ...
    /**
     * Returns true when this object is a BattleArmor unit or of type BA for Alpha
     * Strike.
     * Returns false for any type of unit group even if it is of the right type.
     *
    ...
    /**
     * Returns true when this object is a Conventional Infantry unit or of type CI
     * for Alpha Strike.
     * Returns false for any type of unit group even if it is of the right type.
     *
    ...
    /**
     * Returns true when this object is a JumpShip (but not a Space Station nor a
     * WarShip).
     * Returns false for any type of unit group.
     *
    ...
    /**
     * Returns true when this object is a WarShip (but not a Space Station nor a
     * JumpShip).
     * Returns false for any type of unit group.
     *
    ...
    /**
     * Returns true when this object is a SpaceStation (but not a WarShip nor a
     * JumpShip).
     * Returns false for any type of unit group.
     *
     ...
     * overriding.
     *
     * @return True when this is object is aerodyne (fighter, aerodyne DropShip or
     *         aerodyne SmallCraft)
     */
    ...
    /**
     * Returns true when this object is a Support Vehicle of any kind (including
    ...
    /**
     * Returns true when this object is any Infantry unit or of type CI/BA for Alpha
     * Strike.
     * Returns false for any type of unit group even if it is of the right type.
     *
    ...
    /**
     * Returns true when this is a group of units or elements such as a TW Squadron,
     * BF Unit or SBF Formation
