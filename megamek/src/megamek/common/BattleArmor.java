...
public class BattleArmor extends Infantry {
    ...
    private static final String[] IS_LOCATION_ABBRS = { "Squad", "Trooper 1", "Trooper 2", "Trooper 3", "Trooper 4",
                                                        "Trooper 5", "Trooper 6" };
    private static final String[] IS_LOCATION_NAMES = { "Squad", "Trooper 1", "Trooper 2", "Trooper 3", "Trooper 4",
                                                        "Trooper 5", "Trooper 6" };
    private static final int[] CLAN_NUM_OF_SLOTS = { 20, 2, 2, 2, 2, 2, 2 };
    private static final String[] CLAN_LOCATION_ABBRS = { "Point", "Trooper 1", "Trooper 2", "Trooper 3", "Trooper 4",
                                                          "Trooper 5", "Trooper 6" };
    private static final String[] CLAN_LOCATION_NAMES = { "Point", "Trooper 1", "Trooper 2", "Trooper 3", "Trooper 4",
                                                          "Trooper 5", "Trooper 6" };
    ...
    /**
     * A list of the internal names for the different manipulator types. The indices in this collection correspond to
     * the MANIPULATOR defines in <code>BattleArmor</code>. These names should match the internal name for the
     * manipulator's MiscType entry.
     */
    public static final String[] MANIPULATOR_TYPE_STRINGS = { "None", "BAArmoredGlove", "BABasicManipulator",
                                                              ...
                                                              "BAHeavyBattleClawVibro", "BASalvageArm",
                                                              EquipmentTypeLookup.BA_MANIPULATOR_CARGO_LIFTER,
                                                              "BAIndustrialDrill" };

    /**
     * A list of the display names for the different manipulator types. The indices in this collection correspond to the
     * MANIPULATOR defines in <code>BattleArmor</code>. These names should match the name for the manipulator's MiscType
     * entry.
     */
    public static final String[] MANIPULATOR_NAME_STRINGS = { "None", "BA Manipulators [Armored Gloves]",
                                                              "BA Manipulators [Manipulator (Basic)]",
                                                              "BA Manipulator Adaptation [Mine Clearance Equipment]",
                                                              "BA Manipulators [Battle Claw]",
                                                              "BA Manipulator Adaptation [Magnetic Battle Claw]",
                                                              "BA Manipulator Adaptation [Vibro-Claw]",
                                                              "BA Manipulators [Heavy Battle Claw]",
                                                              "BA Manipulator Adaptation [Heavy Magnetic Battle Claw]",
                                                              "BA Manipulator Adaptation [Heavy Vibro-Claw]",
                                                              "BA Manipulators [Salvage Arm]",
                                                              "BA Manipulators [Cargo Lifter]",
    ...
    /**
     * Flag that is <code>true</code> when this object's constructor has completed.
     */
    ...
    /**
     * Flag that is <code>true</code> when this unit is equipped with mimetic armor.
     */
    private boolean isMimetic = false;

    /**
     * Flag that is <code>true</code> when this unit is equipped with a camo system.
     */
    ...
    /**
     * Returns the number of Troopers in the BattleArmor squad, since locations for BattleArmor correspond to the
     * different suits instead of the actual mount locations for equipment.
     */
    @Override
    ...
    protected static final TechAdvancement[] TA_BATTLEARMOR = {
          new TechAdvancement(TECH_BASE_ALL).setISAdvancement(2710, DATE_NONE, 3058, 2766, 2905)
                ...
                .setAvailability(RATING_F, RATING_X, RATING_E, RATING_D).setStaticTechLevel(SimpleTechLevel.STANDARD),
          // PA(L)
          new TechAdvancement(TECH_BASE_ALL).setISAdvancement(DATE_NONE, 3050, 3050)
                ...
                .setProductionFactions(F_CIH, F_FS, F_LC)
                .setClanApproximate(true, false, false)
                .setTechRating(RATING_E)
                .setAvailability(RATING_X, RATING_F, RATING_E, RATING_D).setStaticTechLevel(SimpleTechLevel.STANDARD),
          // light
          new TechAdvancement(TECH_BASE_ALL).setISAdvancement(2864, 3052, 3052)
                ...
                .setProductionFactions(F_CWF, F_FS, F_LC, F_CS)
                .setTechRating(RATING_E)
                .setAvailability(RATING_X, RATING_D, RATING_D, RATING_D).setStaticTechLevel(SimpleTechLevel.STANDARD),
          // medium
          new TechAdvancement(TECH_BASE_ALL).setISAdvancement(DATE_NONE, 3050, 3058)
                .setClanAdvancement(2867, 2875, 3058)
                .setClanApproximate(true, false, false)
                .setPrototypeFactions(F_CWF)
                .setProductionFactions(F_CHH, F_FS, F_LC)
                .setTechRating(RATING_E)
                .setAvailability(RATING_X, RATING_F, RATING_E, RATING_D).setStaticTechLevel(SimpleTechLevel.STANDARD),
          // heavy
          new TechAdvancement(TECH_BASE_ALL).setISAdvancement(DATE_NONE, 3058, 3060)
                ...
                .setProductionFactions(F_CGB, F_DC)
                .setTechRating(RATING_E)
                .setAvailability(RATING_X, RATING_F, RATING_E, RATING_D).setStaticTechLevel(SimpleTechLevel.STANDARD)
          // assault
    };
    ...
    public int getRunMP(MPCalculationSetting mpCalculationSetting) {
        boolean fastMove = !mpCalculationSetting.ignoreOptionalRules &&
                                 (game != null) &&
    ...
    public int getJumpMP(MPCalculationSetting mpCalculationSetting) {
        ...
        if ((game != null)) {
            ...
            if ((mp > 0) && hasWorkingMisc(MiscType.F_PARTIAL_WING) && ignoreGameLessThanThin) {
                mp++;
            }
        } else {
    ...
    /**
     * Determines if the battle armor unit is burdened with un-jettisoned equipment. This can prevent the unit from
     * jumping or using their special Anti-Mek attacks.
     *
    ...
    /**
     * Returns true if this <code>BattleArmor</code> can use a detachable weapon pack. A <code>BattleArmor</code> must
     * have 2 or more walking MP and be Medium or heavier to mount DWP.
     * <p>
     * Used in MML!
     *
    ...
    public boolean canMountDWP() {
        return (getOriginalWalkMP() >= 2) && (getWeightClass() >= EntityWeightClass.WEIGHT_MEDIUM);
    }
    ...
    public double getAlternateCost() {
        return BattleArmorCostCalculator.calculateCost(this, new DummyCalculationReport(), false, false);
    }
     ...
     *
     * @param ignoreEquipment If true, bonuses from equipment like partial wing and jump booster are ignored. This is
    ...
    public int getMaximumJumpMP(boolean ignoreEquipment) {
        ...
        if (!ignoreEquipment && (hasWorkingMisc(MiscType.F_JUMP_BOOSTER) || hasWorkingMisc(MiscType.F_PARTIAL_WING))) {
            max++;
        }
    ...
    public Mounted<?> getLeftManipulator() {
        for (Mounted<?> m : getMisc()) {
            if (m.getType().hasFlag(MiscType.F_BA_MANIPULATOR) && (m.getBaMountLoc() == MOUNT_LOC_LARM)) {
                return m;
            }
        }
        return null;
    ...
    public Mounted<?> getRightManipulator() {
        for (Mounted<?> m : getMisc()) {
            if (m.getType().hasFlag(MiscType.F_BA_MANIPULATOR) && (m.getBaMountLoc() == MOUNT_LOC_RARM)) {
                return m;
            }
        }
        return null;
