...
public enum BayType implements ITechnologyDelegator {
     ...
     * CATEGORY_CARGO is for bulk transport and can be sized in fractional
     * increments (usually half ton).
     * Capacity is the fraction of bay tonnage that is available for storage.
     * CATEGORY_INFANTRY calculates cost based on tonnage rather than unit capacity
     * and has no cost for aerospace units.
    ...
    /**
     * @return The tonnage weight of a single unit of the bay type. For cargo the
     *         base unit is a single ton;
     *         for units the base unit is a number of Entity units equal to the
     *         capacity.
     */
    ...
    /**
     * @return The capacity of a single unit of the bay type. For cargo the is the
     *         number of tons of cargo
     *         that can be stored in a single ton of bay capacity. For unit
     *         transport bays this is the Entity
    ...
    /**
     * @return The number of personnel that can be housed in by each unit of the
     *         bay.
     */
    ...
    /**
     * @return The base cost of a single unit of the bay type. Note that the cost
     *         for infantry units
     *         (conventional and battlearmor) is per ton and not per platoon/squad
     *         and aerospace units
