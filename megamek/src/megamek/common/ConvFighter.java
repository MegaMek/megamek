...
public class ConvFighter extends AeroSpaceFighter {
    ...
    protected static final TechAdvancement TA_CONV_FIGHTER = new TechAdvancement(TechBase.ALL)
            .setAdvancement(DATE_NONE, 2470, 2490).setProductionFactions(Faction.TH)
            .setTechRating(TechRating.D).setAvailability(AvailabilityValue.C, AvailabilityValue.D, AvailabilityValue.C, AvailabilityValue.B)
