...
/**
 * Compares two ECMInfo to determine which should take precedence, assuming that the goal is to find the strongest ECM
 * field.
 */
public class ECMComparator implements Comparator<ECMInfo> {
