...
public abstract class Entity extends TurnOrdered implements Transporter,
     ...
     */
    public boolean checkTurnModeFailure(EntityMovementType overallMoveType,
            int straightLineHexes, int mpUsed, Coords currPos, Vector<Report> vDesc) {
        ...
        r.add(roll.getDesc());
        r.add(nRoll);
        boolean passed = nRoll >= roll.getValue();
        r.choose(passed);
        vDesc.add(r);
        return !passed;
    }
