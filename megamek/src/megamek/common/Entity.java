...
Targetable, RoundUpdated, PhaseUpdated {
    ...
    public static final int BATTLEFORCE_SHORT_CAPITAL = 0;
    public static final int BATTLEFORCE_MEDIUM_CAPITAL = 13;
    public static final int BATTLEFORCE_LONG_CAPITAL = 25;
    public static final int BATTLEFORCE_EXTREME_CAPITAL = 41;
    
    public static final int BATTLEFORCE_STANDARD_SCALE = 0;
    public static final int BATTLEFORCE_CAPITAL = 1;
    public static final int BATTLEFORCE_CAPITAL_MISSILES = 2;
    public static final int BATTLEFORCE_SUBCAPITAL = 3;
       ...
       */
        ...
        */
        ...
        public int getBattleForceStandardWeaponsDamage(int range, int location, int ammoType,
                boolean ignoreHeat, boolean ignoreSpecialAbilities) {
            return getBattleForceStandardWeaponsDamage(range, location, AmmoType.T_NA,
                    ignoreHeat, ignoreSpecialAbilities, BATTLEFORCE_STANDARD_SCALE);
        }
        /**
         * @param range
         * @param ammoType
         ...
         * @param scale                whether this is standard, capital, capital missile, or subcapital
         * @return
         */
        public int getBattleForceStandardWeaponsDamage(int range, int location, int ammoType,
                boolean ignoreHeat, boolean ignoreSpecialAbility, int scale) {
            ...
            for (int pos = 0; pos < weaponsList.size(); pos++) {
                ...
                if ((scale == BATTLEFORCE_STANDARD_SCALE && weapon.isCapital())
                        || (scale == BATTLEFORCE_CAPITAL_MISSILES && weapon.getAtClass() != WeaponType.CLASS_CAPITAL_MISSILE)
                        || (scale == BATTLEFORCE_SUBCAPITAL && weapon.isSubCapital())) {
                    continue;
                }
