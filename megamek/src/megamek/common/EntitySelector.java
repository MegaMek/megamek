...
/**
 * Implementing classes perform a test to determine if an <code>Entity</code> meets the selection criteria.
 *
...
public interface EntitySelector {
    /**
     * Determine if the given <code>Entity</code> meets the selection criteria.
     *
