...
public enum EquipmentFlag {
    ...
    public static EquipmentFlag fromFlagPosition(int flagPosition) {
        for (EquipmentFlag flag : values()) {
            if (flag.getFlagPosition() == flagPosition) {
                return flag;
            }
        }
        throw new IllegalArgumentException("No EquipmentFlag found for flag position " + flagPosition);
    }
    ...
    public static Set<EquipmentFlag> fromBitSet(BitSet bitSet) {
        Set<EquipmentFlag> flags = new HashSet<>();
        for (EquipmentFlag flag : values()) {
    ...
    public static EquipmentFlagBitSet fromSet(Set<EquipmentFlag> flags) {
        EquipmentFlagBitSet bitSet = new EquipmentFlagBitSet();
