...
/**
 * Constants that can be used as lookup keys for {@link EquipmentType#get}. The constant should be used as the internal
 * name when creating the {@link EquipmentType}.
 * <p>
 * This is not a complete list, as most equipment does not need to be retrieved directly. It is primarily for use by the
 * construction rules when a specific piece of equipment is required. Armor and structure have their own methods that
 * take tech base into account.
 *
...
public class EquipmentTypeLookup {
    ...
    /**
     * Static fields in this class annotated with {code @EquipmentName} will be checked by the unit tests to verify they
     * are valid {@link EquipmentType} lookup keys.
     */
    ...
    @EquipmentName
    public static final String MEK_UMU = "UMU";
    @EquipmentName
    public static final String MECHANICAL_JUMP_BOOSTER = "MechanicalJumpBooster";
    @EquipmentName
    public static final String VEHICLE_JUMP_JET = "VehicleJumpJet";
    @EquipmentName
    public static final String PROTOMEK_JUMP_JET = "ProtoMechJumpJet";
    @EquipmentName
    public static final String EXTENDED_JUMP_JET_SYSTEM = "ExtendedJumpJetSystem";
    @EquipmentName
    public static final String PROTOMEK_UMU = "ProtoMechUMU";
    @EquipmentName
    public static final String PROTOMEK_MYOMER_BOOSTER = "CLMyomerBooster";
    @EquipmentName
    public static final String PROTOMEK_MELEE = "ProtoMeleeWeapon";
    @EquipmentName
    public static final String PROTOMEK_QUAD_MELEE = "ProtoQuadMeleeSystem";
    ...
    @EquipmentName
    public static final String BA_MANIPULATOR_CARGO_LIFTER = "BACargoLifter";
    @EquipmentName
    public static final String BA_MAGNETIC_CLAMP = "BA-Magnetic Clamp";
    @EquipmentName
    public static final String BA_PARAFOIL = "BAParafoil";
    @EquipmentName
    ...
    @EquipmentName
    public static final String ANTI_MEK_GEAR = "AntiMekGear";
    ...
    @EquipmentName
    public static final String LIGHT_BRIDGE_LAYER = "LightBridgeLayer";
    @EquipmentName
    public static final String MEDIUM_BRIDGE_LAYER = "MediumBridgeLayer";
    @EquipmentName
    public static final String HEAVY_BRIDGE_LAYER = "HeavyBridgeLayer";
    @EquipmentName
    ...
    @EquipmentName
    public static final String DUAL_SAW = "Dual Saw";
    @EquipmentName
    public static final String DUMPER_FRONT = "Dumper (Front)";
    @EquipmentName
    public static final String DUMPER_REAR = "Dumper (Rear)";
    @EquipmentName
    public static final String DUMPER_RIGHT = "Dumper (Right)";
    @EquipmentName
    public static final String DUMPER_LEFT = "Dumper (Left)";
    @EquipmentName
    public static final String EXTENDED_FUEL_TANK = "Extended Fuel Tank";
    @EquipmentName
    public static final String PILE_DRIVER = "Heavy-Duty Pile Driver";
    @EquipmentName
    ...
    @EquipmentName
    public static final String MINING_DRILL = "MiningDrill";
    @EquipmentName
    ...
    @EquipmentName
    public static final String SALVAGE_ARM = "Salvage Arm";
    @EquipmentName
    public static final String SPOT_WELDER = "Spot Welder";
    @EquipmentName
    public static final String SPRAYER_MEK = "MechSprayer";
    @EquipmentName
    public static final String SPRAYER_VEE = "Tank Sprayer";
    @EquipmentName
    public static final String WRECKING_BALL = "IS Wrecking Ball";
    @EquipmentName
    public static final String LAM_FUEL_TANK = "LAM Fuel Tank";
    @EquipmentName
    ...
    @EquipmentName
    public static final String SNIPER_ARTY = "ISSniper";
