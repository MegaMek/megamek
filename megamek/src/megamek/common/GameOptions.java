...
public class GameOptions extends Options implements Serializable {
    ...
    public void initialize() {
        ...
        addOption(level3, new GameOption("maxtech_burst", "MaxTech Burst Fire MGs", "If checked, MGs may use burst fire rules: They inflict 1D6 of damage, create an equal amount of heat and use triple the amount of ammunition. Click the 'Configure Unit' button to configure MGs. Defaults to false.", false));
