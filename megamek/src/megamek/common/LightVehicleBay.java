...
public final class LightVehicleBay extends Bay {
     ...
     */
    public LightVehicleBay(double space, int doors) {
        totalSpace = space;
        currentSpace = space;
        this.doors = doors;
        doorsNext = doors;
    ...
    public String getUnusedString() {
        return "Light Vehicle Bay - " + String.format("%1$,.0f", currentSpace) + (currentSpace > 1 ? " units" : " unit");
    }
    ...
    public String toString() {
        return "lightvehiclebay:" + totalSpace + ":" + doors;
    }
