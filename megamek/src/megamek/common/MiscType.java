...
public class MiscType extends EquipmentType {
	...
	public static MiscType createJumpJet() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_ALL).setISAdvancement(2464, 2471, 2500, DATE_NONE, DATE_NONE)
				...
				.setAvailability(RATING_C, RATING_C, RATING_C, RATING_C).setStaticTechLevel(SimpleTechLevel.INTRO);
		return misc;
	}
	...
	public static MiscType createVehicluarJumpJet() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_ALL).setISAdvancement(2650, 3083).setApproximate(false, true)
				.setPrototypeFactions(F_TH).setProductionFactions(F_CHH).setTechRating(RATING_E)
	...
	public static MiscType createProtomechJumpJet() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_CLAN).setClanAdvancement(3055, 3060, 3060)
				.setClanApproximate(true, false, false).setPrototypeFactions(F_CSJ).setProductionFactions(F_CSJ)
	...
	public static MiscType createExtendedJumpJet() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_CLAN).setClanAdvancement(3071, 3075, 3085, DATE_NONE, DATE_NONE)
				...
				.setAvailability(RATING_X, RATING_X, RATING_F, RATING_D).setStaticTechLevel(SimpleTechLevel.STANDARD);
		return misc;
	}
	...
	public static MiscType createProtomechUMU() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_CLAN).setClanAdvancement(3065, 3075, 3084)
				.setClanApproximate(true, true, false).setPrototypeFactions(F_CBS).setProductionFactions(F_CBS)
	...
	public static MiscType createJumpBooster() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_IS).setISAdvancement(3060, 3083, 3090)
				.setISApproximate(true, false, false).setPrototypeFactions(F_FS).setProductionFactions(F_FS, F_LC)
	...
	public static MiscType createISUMU() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_ALL).setISAdvancement(3061, 3066, 3084, DATE_NONE, DATE_NONE)
				.setClanAdvancement(DATE_NONE, 3072, 3084, DATE_NONE, DATE_NONE).setPrototypeFactions(F_CGS)
	...
	public static MiscType createCLSuperCharger() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_CLAN).setTechRating(RATING_C)
				.setAvailability(RATING_F, RATING_F, RATING_F, RATING_D).setClanAdvancement(DATE_ES, 3078)
				.setClanApproximate(false, true, false, false, false).setStaticTechLevel(SimpleTechLevel.EXPERIMENTAL);
	...
	public static MiscType createPrimitiveFighterArmor() {
		...
		misc.rulesRefs = "125,IO";
		misc.techAdvancement.setTechBase(TECH_BASE_IS).setTechRating(RATING_C)
				.setAvailability(RATING_B, RATING_C, RATING_B, RATING_B).setISAdvancement(DATE_ES, 2300, 2315)
				.setISApproximate(false, true, true).setClanApproximate(false, true, true, false, false)
	...
	public static MiscType createStandard() {
		...
		misc.flags = misc.flags.or(F_MECH_EQUIPMENT).or(F_TANK_EQUIPMENT).or(F_VTOL_EQUIPMENT).or(F_FIGHTER_EQUIPMENT);
		misc.criticals = 0;
	...
	public static MiscType createFerroAlumPrototype() {
		...
		misc.hittable = false;
		misc.spreadable = true;
		misc.flags = misc.flags.or(F_FERRO_FIBROUS_PROTO).or(F_FIGHTER_EQUIPMENT).or(F_SC_EQUIPMENT).or(F_DS_EQUIPMENT);
		misc.omniFixedOnly = true;
		misc.bv = 0;
		misc.rulesRefs = "72,IO";
		misc.techAdvancement.setTechBase(TECH_BASE_IS).setTechRating(RATING_E)
	...
	public static MiscType createPrimitiveLCAerospaceArmor() {
		...
		misc.bv = 0;
		misc.industrial = true;
		misc.flags = misc.flags.or(F_PRIMITIVE_ARMOR).or(F_SC_EQUIPMENT).or(F_DS_EQUIPMENT).or(F_JS_EQUIPMENT)
				.or(F_WS_EQUIPMENT).or(F_SS_EQUIPMENT);
		misc.omniFixedOnly = true;
		misc.rulesRefs = "125,IO";
		misc.techAdvancement.setTechBase(TECH_BASE_IS).setTechRating(RATING_C)
				.setAvailability(RATING_B, RATING_C, RATING_B, RATING_B).setISAdvancement(DATE_ES, 2300, 2315)
				.setISApproximate(false, true, true).setProductionFactions(F_TH)
				.setStaticTechLevel(SimpleTechLevel.STANDARD);
		return misc;
	}
	...
	public static MiscType createISAeroSpaceArmor() {
		...
		misc.hittable = false;
		misc.spreadable = true;
		misc.flags = misc.flags.or(F_SC_EQUIPMENT).or(F_DS_EQUIPMENT).or(F_JS_EQUIPMENT).or(F_WS_EQUIPMENT)
				.or(F_SS_EQUIPMENT);
		misc.omniFixedOnly = true;
		misc.bv = 0;
		misc.rulesRefs = "205,TM";
		misc.techAdvancement.setTechBase(TECH_BASE_IS).setTechRating(RATING_D)
				.setAvailability(RATING_C, RATING_C, RATING_C, RATING_B).setISAdvancement(2460, 2470, 2470)
				.setISApproximate(true, false, false).setPrototypeFactions(F_TH).setProductionFactions(F_TH)
				.setStaticTechLevel(SimpleTechLevel.STANDARD);
		return misc;
	}
	...
	public static MiscType createClanAeroSpaceArmor() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_CLAN).setTechRating(RATING_D)
				.setAvailability(RATING_C, RATING_C, RATING_C, RATING_B).setClanAdvancement(DATE_NONE, DATE_NONE, 2470)
				.setStaticTechLevel(SimpleTechLevel.STANDARD);
		return misc;
	}
	...
	public static MiscType createISImpFerroAluminumArmor() {
		...
		misc.hittable = false;
		misc.bv = 0;
		misc.flags = misc.flags.or(F_CAPITAL_ARMOR).or(F_IMP_FERRO).or(F_JS_EQUIPMENT).or(F_WS_EQUIPMENT)
				.or(F_SS_EQUIPMENT);
		misc.omniFixedOnly = true;
	...
	public static MiscType createCLImpFerroAluminumArmor() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_CLAN).setTechRating(RATING_E)
				.setAvailability(RATING_E, RATING_X, RATING_E, RATING_D).setClanAdvancement(2500, 2520)
				.setClanApproximate(false, true).setStaticTechLevel(SimpleTechLevel.ADVANCED);
		return misc;
	}
	...
	public static MiscType createISFerroCarbideArmor() {
		...
		misc.hittable = false;
		misc.bv = 0;
		misc.flags = misc.flags.or(F_CAPITAL_ARMOR).or(F_FERRO_CARBIDE).or(F_JS_EQUIPMENT).or(F_WS_EQUIPMENT)
				.or(F_SS_EQUIPMENT);
		misc.omniFixedOnly = true;
		misc.rulesRefs = "152,SO";
		misc.techAdvancement.setTechBase(TECH_BASE_IS).setTechRating(RATING_E)
				...
				.setPrototypeFactions(F_TH).setProductionFactions(F_TH).setReintroductionFactions(F_DC, F_LC)
				.setStaticTechLevel(SimpleTechLevel.ADVANCED);
		return misc;
	}
	...
	public static MiscType createCLFerroCarbideArmor() {
		...
		misc.rulesRefs = "152,SO";
		misc.techAdvancement.setTechBase(TECH_BASE_ALL).setTechRating(RATING_E)
				.setAvailability(RATING_E, RATING_X, RATING_E, RATING_D).setClanAdvancement(2550, 2570)
				.setClanApproximate(true, false).setStaticTechLevel(SimpleTechLevel.ADVANCED);
		return misc;
	}
	...
	public static MiscType createISLamellorFerroCarbideArmor() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_IS).setTechRating(RATING_F)
				...
				.setPrototypeFactions(F_TH).setProductionFactions(F_TH).setReintroductionFactions(F_FS, F_FW, F_LC)
				.setStaticTechLevel(SimpleTechLevel.ADVANCED);
		return misc;
	}
	...
	public static MiscType createCLLamellorFerroCarbideArmor() {
		...
		misc.rulesRefs = "152,SO";
		misc.techAdvancement.setTechBase(TECH_BASE_CLAN).setTechRating(RATING_F)
				.setAvailability(RATING_E, RATING_F, RATING_E, RATING_D).setClanAdvancement(2600, 2615)
				.setClanApproximate(true, false).setStaticTechLevel(SimpleTechLevel.ADVANCED);
		return misc;
	}
	...
	public static MiscType createISBAStandardArmor() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_IS).setISAdvancement(2680, DATE_NONE, 3054, 2800, 3050)
				...
				.setAvailability(RATING_F, RATING_F, RATING_E, RATING_D).setStaticTechLevel(SimpleTechLevel.STANDARD);
	...
	public static MiscType createClanBAStandardArmor() {
		...
		misc.bv = 0;
		misc.rulesRefs = "252,TM";
		misc.techAdvancement.setTechBase(TECH_BASE_CLAN).setClanAdvancement(DATE_NONE, 2868, 3054)
				.setClanApproximate(true, false, false).setProductionFactions(F_CWF).setTechRating(RATING_E)
				.setAvailability(RATING_F, RATING_F, RATING_E, RATING_D).setStaticTechLevel(SimpleTechLevel.STANDARD);
	...
	public static MiscType createClanBAFireResistantArmor() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_CLAN).setClanAdvancement(3052, 3058, 3065)
				.setClanApproximate(true, false, false).setPrototypeFactions(F_CFM).setProductionFactions(F_CFM)
	...
	public static MiscType createClanBABasicStealth() {
		...
		misc.bv = 0;
		misc.rulesRefs = "252,TM";
		misc.techAdvancement.setTechBase(TECH_BASE_CLAN).setClanAdvancement(DATE_NONE, DATE_NONE, 3054)
				.setTechRating(RATING_E).setAvailability(RATING_F, RATING_F, RATING_E, RATING_D);
	...
	public static MiscType createClanBAStandardStealth() {
		...
		misc.bv = 0;
		misc.rulesRefs = "252,TM";
		misc.techAdvancement.setTechBase(TECH_BASE_CLAN).setClanAdvancement(DATE_NONE, DATE_NONE, 3055)
				.setPrototypeFactions(F_TH).setTechRating(RATING_E)
				.setAvailability(RATING_F, RATING_X, RATING_E, RATING_D);
	...
	public static MiscType createClanBAImprovedStealth() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_CLAN).setClanAdvancement(DATE_NONE, 3058, 3059)
	...
	public static MiscType createISBAReactiveArmor() {
		...
		misc.bv = 0;
		misc.rulesRefs = "282,TO";
		misc.techAdvancement.setTechBase(TECH_BASE_IS).setISAdvancement(3075, 3093, 3100)
				.setISApproximate(false, true, false).setProductionFactions(F_RS).setTechRating(RATING_F)
				.setAvailability(RATING_X, RATING_X, RATING_F, RATING_E);
	...
	public static MiscType createClanBAReactiveArmor() {
		...
		misc.bv = 0;
		misc.rulesRefs = "282,TO";
		misc.techAdvancement.setTechBase(TECH_BASE_CLAN).setClanAdvancement(3075, 3093, 3100)
				.setClanApproximate(false, true, false).setPrototypeFactions(F_CSF).setTechRating(RATING_F)
				.setAvailability(RATING_X, RATING_X, RATING_F, RATING_E);
	...
	public static MiscType createISBAReflectiveArmor() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_IS).setISAdvancement(3074, 3089, 3105)
				.setISApproximate(false, true, false).setProductionFactions(F_DC).setTechRating(RATING_F)
				.setAvailability(RATING_X, RATING_X, RATING_F, RATING_E);
	...
	public static MiscType createClanBAReflectiveArmor() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_CLAN).setClanAdvancement(3074, 3089, 3105)
				.setClanApproximate(false, true, false).setPrototypeFactions(F_CSF).setProductionFactions(F_CNC)
				.setTechRating(RATING_F).setAvailability(RATING_X, RATING_X, RATING_F, RATING_E);
	...
	public static MiscType createGenericInfArmor() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_ALL).setTechRating(RATING_C)
				...
				.setClanApproximate(false, false, false, false, false).setStaticTechLevel(SimpleTechLevel.STANDARD);
		return misc;
	}
	...
	public static MiscType createEmergencyC3M() {
		...
		misc.flags = misc.flags.or(F_C3EM).or(F_MECH_EQUIPMENT).or(F_TANK_EQUIPMENT).or(F_C3S)
	...
	public static MiscType createBC3() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_IS).setTechRating(RATING_E)
				.setAvailability(RATING_X, RATING_X, RATING_E, RATING_E).setISAdvancement(3073, 3095)
				.setPrototypeFactions(F_DC).setProductionFactions(F_DC)
				.setStaticTechLevel(SimpleTechLevel.EXPERIMENTAL);
		return misc;
	}
	...
	public static MiscType createBC3i() {
		...
		misc.rulesRefs = "297,TO";
		misc.techAdvancement.setTechBase(TECH_BASE_IS).setTechRating(RATING_E)
				.setAvailability(RATING_X, RATING_X, RATING_E, RATING_E).setISAdvancement(3063, 3095)
				.setPrototypeFactions(F_WB).setProductionFactions(F_RS)
				.setStaticTechLevel(SimpleTechLevel.EXPERIMENTAL);
		return misc;
	}
	...
	public static MiscType createISMASS() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_ALL).setTechRating(RATING_D)
				...
				.setAdvancement(3048, 3083, DATE_NONE, DATE_NONE, DATE_NONE).setPrototypeFactions(F_FS, F_CGS)
				.setProductionFactions(F_FS).setStaticTechLevel(SimpleTechLevel.EXPERIMENTAL);
		return misc;
	}
	...
	public static MiscType createSmartRoboticControlSystem() {
		...
		misc.subType = S_STANDARD;
		misc.techAdvancement.setTechBase(TECH_BASE_ALL).setTechRating(RATING_C)
				.setAvailability(RATING_E, RATING_F, RATING_F, RATING_F).setAdvancement(DATE_ES, DATE_ES)
				.setStaticTechLevel(SimpleTechLevel.ADVANCED);
	...
	public static MiscType createShieldedAeroSRCS() {
		...
		misc.criticals = 0;
		misc.cost = COST_VARIABLE;
		misc.flags = misc.flags.or(F_SASRCS).or(F_FIGHTER_EQUIPMENT).or(F_SC_EQUIPMENT).or(F_SS_EQUIPMENT)
				.or(F_SUPPORT_TANK_EQUIPMENT);
		misc.subType = S_STANDARD;
		misc.rulesRefs = "141,IO";
		misc.techAdvancement.setTechBase(TECH_BASE_ALL).setTechRating(RATING_C)
				.setAvailability(RATING_E, RATING_F, RATING_F, RATING_F)
				.setISAdvancement(2755, DATE_ES, DATE_NONE, 2780, 3077).setClanAdvancement(2755, DATE_ES)
				.setReintroductionFactions(F_WB).setStaticTechLevel(SimpleTechLevel.EXPERIMENTAL);
	...
	public static MiscType createCasparDroneControlSystem() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_ALL).setTechRating(RATING_F)
				...
				.setISAdvancement(2695, DATE_NONE, DATE_NONE, 2780).setClanAdvancement(2695).setPrototypeFactions(F_TH)
				.setStaticTechLevel(SimpleTechLevel.EXPERIMENTAL);
	...
	public static MiscType createCasparIIDroneControlSystem() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_IS).setTechRating(RATING_E)
				.setAvailability(RATING_X, RATING_X, RATING_F, RATING_X)
				.setISAdvancement(3064, DATE_NONE, DATE_NONE, 3078, 3082).setPrototypeFactions(F_WB)
				.setReintroductionFactions(F_RS).setStaticTechLevel(SimpleTechLevel.EXPERIMENTAL);
	...
	public static MiscType createISCombatVehicleEscapePod() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_IS).setTechRating(RATING_D)
				.setAvailability(RATING_X, RATING_X, RATING_E, RATING_E).setISAdvancement(3038, 3079)
	...
	public static MiscType createISReconCamera() {
		...
		misc.cost = 10000;
		misc.flags = misc.flags.or(F_MECH_EQUIPMENT).or(F_TANK_EQUIPMENT).or(F_VTOL_EQUIPMENT).or(F_FIGHTER_EQUIPMENT)
				.or(F_SC_EQUIPMENT).or(F_RECON_CAMERA);
	...
	public static MiscType createISLookDownRadar() {
		...
		misc.cost = 400000;
		misc.criticals = 1;
		misc.flags = misc.flags.or(F_LOOKDOWN_RADAR).or(F_VTOL_EQUIPMENT).or(F_FIGHTER_EQUIPMENT).or(F_SC_EQUIPMENT)
				.or(F_DS_EQUIPMENT);
		misc.bv = 0;
	...
	public static MiscType createISInfraredImager() {
		...
		misc.tonnage = 5;
		misc.cost = 250000;
		misc.flags = misc.flags.or(F_INFRARED_IMAGER).or(F_VTOL_EQUIPMENT).or(F_FIGHTER_EQUIPMENT).or(F_SC_EQUIPMENT)
	...
	public static MiscType createISHyperspectralImager() {
		...
		misc.cost = 550000;
		misc.criticals = 1;
		misc.flags = misc.flags.or(F_HIRES_IMAGER).or(F_VTOL_EQUIPMENT).or(F_FIGHTER_EQUIPMENT).or(F_SC_EQUIPMENT)
				.or(F_DS_EQUIPMENT).or(F_JS_EQUIPMENT).or(F_WS_EQUIPMENT).or(F_SS_EQUIPMENT);
		misc.bv = 0;
	...
	public static MiscType createISProtoArtemis() {
		...
		misc.criticals = 1;
		misc.cost = 100000;
		misc.flags = misc.flags.or(F_ARTEMIS_PROTO).or(F_MECH_EQUIPMENT).or(F_TANK_EQUIPMENT).or(F_FIGHTER_EQUIPMENT)
				.or(F_SC_EQUIPMENT).or(F_DS_EQUIPMENT).or(F_JS_EQUIPMENT).or(F_WS_EQUIPMENT).or(F_SS_EQUIPMENT);
	...
	public static MiscType createHeatSink() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_ALL)
				...
				.setAvailability(RATING_B, RATING_B, RATING_B, RATING_B).setStaticTechLevel(SimpleTechLevel.INTRO);
		return misc;
	}
	...
	public static MiscType createIS1CompactHeatSink() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_IS).setISAdvancement(3058, 3079).setISApproximate(false, false)
				.setPrototypeFactions(F_FS).setProductionFactions(F_FS).setTechRating(RATING_E)
				.setAvailability(RATING_X, RATING_X, RATING_F, RATING_E)
				.setStaticTechLevel(SimpleTechLevel.EXPERIMENTAL);
		return misc;
	}
	...
	public static MiscType createRefuelingDrogue() {
		...
		misc.flags = misc.flags.or(F_REFUELING_DROGUE).or(F_FIGHTER_EQUIPMENT).or(F_VTOL_EQUIPMENT).or(F_SC_EQUIPMENT);
		misc.industrial = true;
	...
	public static MiscType createNC3() {
		...
		misc.criticals = 0;
		misc.cost = COST_VARIABLE;
		misc.flags = misc.flags.or(F_NAVAL_C3).or(F_DS_EQUIPMENT).or(F_JS_EQUIPMENT).or(F_WS_EQUIPMENT)
				.or(F_SS_EQUIPMENT);
		misc.bv = 0;
		misc.rulesRefs = "332,TO";
		misc.techAdvancement.setTechBase(TECH_BASE_IS).setTechRating(RATING_F)
				.setAvailability(RATING_X, RATING_X, RATING_F, RATING_E).setISAdvancement(3065)
	...
	public static MiscType createISLaserInsulator() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_ALL).setIntroLevel(false).setUnofficial(false)
				...
				.setAdvancement(2575, DATE_NONE, DATE_NONE, 2820, DATE_NONE).setPrototypeFactions(F_TH)
				.setStaticTechLevel(SimpleTechLevel.EXPERIMENTAL);
		return misc;
	}
	...
	public static MiscType createISSpaceMineDispenser() {
		...
		misc.flags = misc.flags.or(F_SUPPORT_TANK_EQUIPMENT).or(F_FIGHTER_EQUIPMENT).or(F_SC_EQUIPMENT)
				.or(F_DS_EQUIPMENT).or(F_JS_EQUIPMENT).or(F_WS_EQUIPMENT).or(F_SS_EQUIPMENT).or(F_SPACE_MINE_DISPENSER);
	...
	public static MiscType createISChaffPod() {
		...
		misc.criticals = 1;
		misc.cost = 2000;
		misc.flags = misc.flags.or(F_CHAFF_POD).or(F_TANK_EQUIPMENT).or(F_MECH_EQUIPMENT).or(F_FIGHTER_EQUIPMENT)
				.or(F_SC_EQUIPMENT).or(F_DS_EQUIPMENT);
		misc.bv = 19;
		misc.rulesRefs = "299,TO";
		misc.techAdvancement.setTechBase(TECH_BASE_IS).setIntroLevel(false).setUnofficial(false).setTechRating(RATING_C)
	...
	public static MiscType createCommsGear1() {
		...
		misc.criticals = 1;
		misc.bv = 0;
		misc.flags = misc.flags.or(F_COMMUNICATIONS).or(F_MECH_EQUIPMENT).or(F_TANK_EQUIPMENT).or(F_FIGHTER_EQUIPMENT)
				.or(F_SC_EQUIPMENT).or(F_DS_EQUIPMENT).or(F_JS_EQUIPMENT).or(F_WS_EQUIPMENT).or(F_SS_EQUIPMENT);
	...
	public static MiscType createISCollapsibleCommandModule() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_ALL).setIntroLevel(false).setUnofficial(false)
				...
				.setClanApproximate(true, false, false, false, false).setStaticTechLevel(SimpleTechLevel.EXPERIMENTAL);
		return misc;
	}
	...
	public static MiscType createFieldKitchen() {
		...
		misc.cost = 25000;
		misc.criticals = 1;
		misc.flags = misc.flags.or(F_FIELD_KITCHEN).or(F_TANK_EQUIPMENT).or(F_DS_EQUIPMENT).or(F_JS_EQUIPMENT)
				.or(F_WS_EQUIPMENT).or(F_SS_EQUIPMENT);
		misc.bv = 0;
		misc.industrial = true;
		misc.rulesRefs = "217,TM";
	...
	public static MiscType createISMobileFieldBase() {
		...
		misc.tonnage = 20;
		misc.cost = 150000;
		misc.flags = misc.flags.or(F_MOBILE_FIELD_BASE).or(F_TANK_EQUIPMENT).or(F_DS_EQUIPMENT).or(F_JS_EQUIPMENT)
				.or(F_WS_EQUIPMENT).or(F_SS_EQUIPMENT);
		misc.bv = 0;
		misc.rulesRefs = "330,TO";
		misc.techAdvancement.setTechBase(TECH_BASE_ALL).setIntroLevel(false).setUnofficial(false)
	...
	public static MiscType createMASH() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_ALL).setTechRating(RATING_B)
				.setAvailability(RATING_C, RATING_E, RATING_D, RATING_C).setISAdvancement(DATE_PS, DATE_PS)
				.setStaticTechLevel(SimpleTechLevel.STANDARD);
		return misc;
	}
	...
	public static MiscType createHandheldSearchlight() {
		...
		misc.criticals = 0;
		misc.tankslots = 0;
		misc.flags.or(F_SEARCHLIGHT).or(F_MECH_EQUIPMENT).or(F_TANK_EQUIPMENT).or(F_FIGHTER_EQUIPMENT)
				.or(F_DS_EQUIPMENT).andNot(F_BA_EQUIPMENT);
		misc.bv = 0;
		misc.cost = 500;
	...
	public static MiscType createSearchlight() {
		...
		misc.tonnage = 0.5;
		misc.criticals = 1;
		misc.flags = misc.flags.or(F_SEARCHLIGHT).or(F_MECH_EQUIPMENT).or(F_TANK_EQUIPMENT).or(F_FIGHTER_EQUIPMENT)
				.or(F_DS_EQUIPMENT);
		misc.bv = 0;
		misc.cost = 2000;
		misc.industrial = true;
	...
	public static MiscType createVoidSignatureSystem() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_IS).setTechRating(RATING_E)
				.setAvailability(RATING_X, RATING_X, RATING_E, RATING_F).setISAdvancement(3070, 3085)
				.setPrototypeFactions(F_WB).setProductionFactions(F_RS)
				.setStaticTechLevel(SimpleTechLevel.EXPERIMENTAL);
		return misc;
	}
	 ...
	 * .setProductionFactions(F_CLAN).setStaticTechLevel(SimpleTechLevel.
	 * EXPERIMENTAL);
	 */
	...
	public static MiscType createISGroundMobileHPG() {
		...
		misc.flags = misc.flags.or(F_MOBILE_HPG).or(F_TANK_EQUIPMENT).or(F_MECH_EQUIPMENT).or(F_SC_EQUIPMENT)
				.or(F_DS_EQUIPMENT).or(F_JS_EQUIPMENT).or(F_WS_EQUIPMENT).or(F_SS_EQUIPMENT).andNot(F_FIGHTER_EQUIPMENT)
				.or(F_SPLITABLE);
		misc.bv = 0;
		misc.rulesRefs = "330,TO";
		misc.techAdvancement.setTechBase(TECH_BASE_ALL).setIntroLevel(false).setUnofficial(false)
	...
	public static MiscType createRISCLaserPulseModule() {
		...
		misc.flags = misc.flags.or(F_RISC_LASER_PULSE_MODULE).or(F_MECH_EQUIPMENT).or(F_TANK_EQUIPMENT)
				...
				.or(F_SS_EQUIPMENT).or(F_VTOL_EQUIPMENT).or(F_PROTOMECH_EQUIPMENT).or(F_SUPPORT_TANK_EQUIPMENT);
		misc.explosive = true;
	...
	public static MiscType createRISCSuperCooledMyomer() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_IS).setIntroLevel(false).setUnofficial(false).setTechRating(RATING_F)
				.setAvailability(RATING_X, RATING_X, RATING_X, RATING_F)
				.setISAdvancement(3133, DATE_NONE, DATE_NONE, 3138, DATE_NONE).setPrototypeFactions(F_RS)
				.setStaticTechLevel(SimpleTechLevel.EXPERIMENTAL);
		return misc;
	}
	...
	public static MiscType createRISCViralJammerDecoy() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_IS).setIntroLevel(false).setUnofficial(false).setTechRating(RATING_F)
				.setAvailability(RATING_X, RATING_X, RATING_X, RATING_F)
				.setISAdvancement(3136, DATE_NONE, DATE_NONE, 3142, DATE_NONE).setPrototypeFactions(F_RS)
				.setStaticTechLevel(SimpleTechLevel.EXPERIMENTAL);
		return misc;
	}
	...
	public static MiscType createRISCViralJammerHoming() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_IS).setIntroLevel(false).setUnofficial(false).setTechRating(RATING_F)
				.setAvailability(RATING_X, RATING_X, RATING_X, RATING_F)
				.setISAdvancement(3137, DATE_NONE, DATE_NONE, 3142, DATE_NONE).setPrototypeFactions(F_RS)
				.setStaticTechLevel(SimpleTechLevel.EXPERIMENTAL);
		return misc;
	}
	...
	public static MiscType createISPPCCapacitor() {
		...
		misc.rulesRefs = "337,TO";
		misc.techAdvancement.setTechBase(TECH_BASE_ALL).setTechRating(RATING_E)
				.setAvailability(RATING_X, RATING_X, RATING_E, RATING_D).setISAdvancement(3060, 3081)
				.setClanAdvancement(DATE_NONE, 3101).setPrototypeFactions(F_DC).setProductionFactions(F_DC)
				.setStaticTechLevel(SimpleTechLevel.EXPERIMENTAL);
		return misc;
	}
	...
	public static MiscType createISCompositeStructure() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_IS).setTechRating(RATING_E)
				.setAvailability(RATING_X, RATING_X, RATING_E, RATING_D).setISAdvancement(3061, 3082)
	...
	public static MiscType createEndoComposite() {
		...
		misc.rulesRefs = "342,TO";
		misc.techAdvancement.setTechBase(TECH_BASE_IS).setTechRating(RATING_E)
				.setAvailability(RATING_X, RATING_X, RATING_F, RATING_E).setISAdvancement(3067, 3085)
				.setClanAdvancement(3073).setISApproximate(false, true).setPrototypeFactions(F_LC, F_CWX)
				.setProductionFactions(F_LC).setStaticTechLevel(SimpleTechLevel.EXPERIMENTAL);
		return misc;
	}
	...
	public static MiscType createReinforcedStructure() {
		...
		misc.rulesRefs = "342,TO";
		misc.techAdvancement.setTechBase(TECH_BASE_ALL).setTechRating(RATING_E)
				.setAvailability(RATING_X, RATING_X, RATING_E, RATING_D).setISAdvancement(3057, 3084)
				.setISApproximate(false, true, false).setClanAdvancement(3065, 3084)
				.setClanApproximate(false, true, false).setPrototypeFactions(F_CS, F_CGB).setProductionFactions(F_CGB)
				.setStaticTechLevel(SimpleTechLevel.EXPERIMENTAL);
		return misc;
	}
	...
	public static MiscType createIndustrialStructure() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_ALL).setTechRating(RATING_C)
				.setAvailability(RATING_C, RATING_C, RATING_C, RATING_C)
				.setAdvancement(2300, 2350, 2490, DATE_NONE, DATE_NONE).setPrototypeFactions(F_TA)
				.setProductionFactions(F_TH);
		return misc;
	}
	...
	public static MiscType createISShoulderTurret() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_ALL).setTechRating(RATING_C)
				.setAvailability(RATING_F, RATING_X, RATING_F, RATING_E).setAdvancement(2450, 3082)
				.setStaticTechLevel(SimpleTechLevel.EXPERIMENTAL);
		return misc;
	}
	...
	public static MiscType createBAJumpJet() {
		...
		misc.rulesRefs = "257,TM";
		misc.techAdvancement.setTechBase(TECH_BASE_ALL).setTechRating(RATING_C)
				.setAvailability(RATING_D, RATING_D, RATING_D, RATING_C).setAdvancement(DATE_ES, DATE_ES, DATE_ES);
		return misc;
	}
	...
	public static MiscType createBAVTOLEquipment() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_CLAN).setTechRating(RATING_F)
				.setAvailability(RATING_X, RATING_X, RATING_F, RATING_E).setClanAdvancement(3052, 3060, 3066)
				.setClanApproximate(true, false, false).setPrototypeFactions(F_CCC).setProductionFactions(F_CCC);
		return misc;
	}
	...
	public static MiscType createBAUMU() {
		...
		misc.techAdvancement.setTechBase(TECH_BASE_CLAN).setTechRating(RATING_F)
				.setAvailability(RATING_X, RATING_E, RATING_E, RATING_E).setClanAdvancement(2840, 3059, 3065)
				.setClanApproximate(true, false, false).setPrototypeFactions(F_CGS).setProductionFactions(F_CGS);
		return misc;
	}
