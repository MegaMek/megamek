...
public class MiscType extends EquipmentType {
    ...
    public float getTonnage(Entity entity, int location) {
        ...
        if (hasFlag(F_JUMP_JET)) {
            ...
            return tons;
        } else if (EquipmentType.getArmorTypeName(T_ARMOR_FERRO_LAMELLOR)
                .equals(internalName)) {
            float tons = 0;
            if (!entity.hasPatchworkArmor()) {
            ...
            return tons;
                ...
                .equals(internalName) || hasFlag(F_ENDO_STEEL)) {
            float tons = 0;
            ...
            return tons;
                ...
                T_STRUCTURE_ENDO_COMPOSITE).equals(internalName)
                || hasFlag(F_ENDO_COMPOSITE)) {
            float tons = 0;
    ...
    public int getCriticals(Entity entity) {
        ...
        if (hasFlag(F_CLUB)
            ...
            return 10;
                ...
                EquipmentType.T_ARMOR_LIGHT_FERRO).equals(internalName)) {
            if (!entity.hasPatchworkArmor()) {
                return 7;
            } else {
                int slots = 0;
                ...
                EquipmentType.T_ARMOR_HEAVY_FERRO).equals(internalName)) {
            if (!entity.hasPatchworkArmor()) {
                return 21;
            } else {
                int slots = 0;
                ...
                EquipmentType.T_ARMOR_FERRO_LAMELLOR).equals(internalName)) {
            if (!entity.hasPatchworkArmor()) {
                return 12;
            } else {
                int slots = 0;
                ...
                EquipmentType.T_ARMOR_FERRO_FIBROUS_PROTO).equals(internalName)) {
            if (!entity.hasPatchworkArmor()) {
                return 16;
            } else {
                int slots = 0;
    ...
    public static MiscType createFerroFibrous() {
        ...
        misc.bv = 0;
        misc.introDate = 2571;
        misc.techLevel.put(2571, TechConstants.T_ALLOWED_ALL);
    ...
    public static MiscType createCommercialArmor() {
        ...
        misc.industrial = true;
        misc.introDate = 2300;
        misc.techLevel.put(2300, TechConstants.T_ALLOWED_ALL);
    ...
    public static MiscType createIndustrialArmor() {
        ...
        misc.industrial = true;
        misc.introDate = 2439;
        misc.techLevel.put(2439, TechConstants.T_ALLOWED_ALL);
    ...
    public static MiscType createHeavyIndustrialArmor() {
        ...
        misc.industrial = true;
        misc.introDate = 3040;
        misc.techLevel.put(3040, TechConstants.T_ALLOWED_ALL);
        misc.availRating = new int[] { RATING_C, RATING_C, RATING_C };
        misc.techRating = RATING_D;
        return misc;
    }
    ...
    public static MiscType createCLEndoSteel() {
        ...
        misc.setInternalName("Clan "
                + EquipmentType.getStructureTypeName(T_STRUCTURE_ENDO_STEEL));
    ...
    public static MiscType createIndustrialStructure() {
        ...
        misc.criticals = 0;
        misc.bv = 0;
        misc.techLevel.put(3071, TechConstants.T_TW_ALL);
        misc.industrial = true;
        misc.introDate = 2350;
    ...
    public static MiscType createReactive() {
        ...
        misc.bv = 0;
        misc.introDate = 3063;
        misc.techLevel.put(3063, TechConstants.T_ALLOWED_ALL);
        misc.availRating = new int[] { RATING_X, RATING_X, RATING_F };
        misc.techRating = RATING_E;
