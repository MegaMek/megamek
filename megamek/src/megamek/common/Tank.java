...
public class Tank extends Entity {
    ...
    public int calculateBattleValue(boolean ignoreC3, boolean ignorePilot) {
        ...
        for (Mounted mounted : getWeaponList()) {
            ...
            if (!((wtype.hasFlag(WeaponType.F_ENERGY) && !((wtype.getAmmoType() == AmmoType.T_PLASMA) || (wtype.getAmmoType() == AmmoType.T_VEHICLE_FLAMER))) || wtype.hasFlag(WeaponType.F_ONESHOT) || wtype.hasFlag(WeaponType.F_INFANTRY) || (wtype.getAmmoType() == AmmoType.T_NA))) {
