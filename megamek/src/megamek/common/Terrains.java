...
public class Terrains implements Serializable {
    ...
    public static final int FIRE = 20; // 1: normal, fire 2: inferno fire, 3:
    ...
    // Building stuff
    public static final int BUILDING = 23; // 1: light 2: medium 3: heavy 4:
                                           // hardened [5: wall not implemented]
    public static final int BLDG_CF = 24;
    public static final int BLDG_ELEV = 25;
    public static final int BLDG_BASEMENT_TYPE = 26; // level equals
                                                     // BasemenType, one of the
                                                     // values of the
                                                     // BasementType enum
    public static final int BLDG_CLASS = 27; // 1: hangars 2: fortresses 3: gun
                                             // emplacements
    ...
    public static final int ARMS = 41; // blown off arms for use as clubs, level
                                       // = number of arms in that hex
    public static final int LEGS = 42; // blown off legs for use as clubs, level
                                       // = number of legs in that hex

    public static final int METAL_CONTENT = 43; // Is there metal content that
    ...
    public static final int BLDG_FLUFF = 45; // Ideally used to denote special bldg images
    public static final int ROAD_FLUFF = 46; // Ideally used to denote special road images
    public static final int GROUND_FLUFF = 47; // Ideally used to denote special ground images
                                            // these should be supers, not bases, as base image
                                            // matching is not exact while super is
    public static final int WATER_FLUFF = 48; // Ideally used to denote special water images

    // Cliffs, use with exits to denote cliffsides; only valid when there's
    // actually a level drop/rise in the specified direction
    public static final int CLIFF_TOP = 49;
    public static final int CLIFF_BOTTOM = 50;
    ...
    public static final int INCLINE_TOP = 51;
    public static final int INCLINE_BOTTOM = 52;
    ...
    // This is added to hexes automatically by MegaMek, not for
    // manual use in the Editor
    public static final int INCLINE_HIGH_TOP = 53;
    public static final int INCLINE_HIGH_BOTTOM = 54;
    ...
    public static final int FOLIAGE_ELEV = 55;
