...
public class TurnVectors implements Enumeration<ITurnOrdered> {
     ...
     * @param evenCount   the <code>int</code> count of markers for turns that occur after all normal turns.
     ...
     *
     * @throws IllegalStateException if as many markers have been added for normal turns as indicated at construction.
     */
     ...
     *
     * @return the <code>TurnOrdered</code> marker; all "even" markers will be returned after all "normal" markers.
     */
    ...
    /**
     * Return the smallest number of times one of the <code>TurnOrdered</code> objects is present in the list of
     * "normal" turns.
     *
