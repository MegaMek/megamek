...
public class ASSpecialAbilityConverter2 {

    protected Entity entity;
    protected AlphaStrikeElement element;
    protected CalculationReport report;

    static ASSpecialAbilityConverter2 getConverter(Entity entity, AlphaStrikeElement element, CalculationReport report) {
        if (element.isLargeAerospace()) { // SC, DS, DA, JS, SS, WS
            ...
            return new ASSpecialAbilityConverter2(entity, element, report);
        }
    }
     ...
     */
    protected ASSpecialAbilityConverter2(Entity entity, AlphaStrikeElement element, CalculationReport report) {
