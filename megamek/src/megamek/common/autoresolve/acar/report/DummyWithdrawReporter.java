...
public class DummyWithdrawReporter implements IWithdrawReporter {

    private final static DummyWithdrawReporter INSTANCE = new DummyWithdrawReporter();

    private DummyWithdrawReporter() {
    }

    public static DummyWithdrawReporter instance() {
        return INSTANCE;
    }
