...
/**
 * Implements internal bays for dropships used by primitive jump ships. See rules IO, p. 119.
 *
 * @author Neoancient
 */
public class DropShuttleBay extends UnitBay {
    ...
    public boolean canLoad(Entity unit) {
        ...
        return unit.hasETypeFlag(Entity.ETYPE_DROPSHIP) && (unit.getWeight() <= 5000) && (currentSpace >= 1);
    }
    ...
    public String toString() {
        ...
        return this.bayString(bayType, totalSpace, doors, bayNumber, "", facing, 0);
    }
