...
public final class InsulatedCargoBay extends Bay {
    ...
    public String getUnusedString(boolean showRecovery) {
        StringBuilder returnString = new StringBuilder("Insulated Cargo Space " + numDoorsString() + " - ");
    ...
    public String toString() {
        String bayType = "insulatedCargoBay";
    ...
    public BayType getBayType() {
        return BayType.INSULATED_CARGO;
    }

    @Override
    public BayData getBayData() {
        return BayData.INSULATED_CARGO;
    }
