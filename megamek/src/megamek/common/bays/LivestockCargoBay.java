...
public final class LivestockCargoBay extends Bay {
     ...
     * @param bayNumber Number of the Bay we're at
     */
    ...
    public String getUnusedString(boolean showRecovery) {
        StringBuilder returnString = new StringBuilder("Livestock Cargo Space " + numDoorsString() + " - ");
    ...
    public BayType getBayType() {
        return BayType.LIVESTOCK_CARGO;
    }

    @Override
    public BayData getBayData() {
        return BayData.LIVESTOCK_CARGO;
    }
