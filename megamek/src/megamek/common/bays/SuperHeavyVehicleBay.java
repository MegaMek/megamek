...
/**
 * Represents a Transport Bay (TM p.239) for carrying super heavy vehicles (not heavier than 200t) aboard large
...
public final class SuperHeavyVehicleBay extends UnitBay {
    ...
    public BayType getBayType() {
        return BayType.VEHICLE_SH;
    }

    @Override
    public BayData getBayData() {
        return BayData.VEHICLE_SH;
    }
}
