...
public class ClientServerCommandLineParser extends AbstractCommandLineParser {
    ...
    public class Resolver {
        ...
        /**
         * path resolves the saveGameFileName arg if it was provided. If it is an absolute path, uses that, otherwise
         * looks first in current working directory and then in ./savegame/
         *
