...
public enum ProstheticEnhancementType {
    ...
    LASER("Laser", EnhancementCategory.RANGED, 0.11, false, false, 0, 0),
    BALLISTIC("Ballistic", EnhancementCategory.RANGED, 0.01, false, false, 0, 0),
    NEEDLER("Needler", EnhancementCategory.RANGED, 0.04, false, false, 0, 0),
    SHOTGUN("Shotgun", EnhancementCategory.RANGED, 0.05, false, false, 0, 0),
    SONIC_STUNNER("Sonic Stunner", EnhancementCategory.RANGED, 0.05, false, true, 0, 0),
    SMG("SMG", EnhancementCategory.RANGED, 0.05, false, false, 0, 0),

    // Melee Weapon enhancements (+2 to-hit modifier)
    BLADE("Blade", EnhancementCategory.MELEE, 0.02, true, true, 2, 0),
    SHOCKER("Shocker", EnhancementCategory.MELEE, 0.04, true, true, 2, 0),
    VIBROBLADE("Vibroblade", EnhancementCategory.MELEE, 0.14, true, false, 2, 0),
    RUMAL_GARROTE("Rumal/Garrote", EnhancementCategory.MELEE, 0.14, true, true, 2, 0),

    // Non-Weapon enhancements (anti-Mek bonuses)
    GRAPPLER("Grappler", EnhancementCategory.NON_WEAPON, 0.0, false, false, 0, -2),
    CLIMBING_CLAWS("Climbing Claws", EnhancementCategory.NON_WEAPON, 0.02, true, true, 0, -1);
    ...
    ProstheticEnhancementType(String displayName, EnhancementCategory category, double damagePerTrooper,
          boolean melee, boolean conventionalInfantryOnly, int toHitModifier, int antiMekModifier) {
        this.displayName = displayName;
