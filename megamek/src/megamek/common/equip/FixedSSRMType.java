...
/* This is used by Battle Armor, as well as One shot launchers */

public class FixedSSRMType extends SSRMissileType {
    ...
    public FixedSSRMType( int tech, int size, Vector valid_ammo, 
