...
public class MiscType extends EquipmentType {
    ...
    public static MiscType createISUMU() {
        ...
        misc.bv = 0;
        misc.industrial = true;
        misc.rulesRefs = rulesRefs(SourceBookCode.TO_AUE, 107);
        // Tech Progression tweaked to combine IntOps with TRO Prototypes/3145 NTNU RS
        misc.techAdvancement.setTechBase(TechBase.ALL)
    ...
    public static MiscType createISSuperCharger() {
        ...
        String[] saModes = { "Armed", "Off" };
        misc.setModes(saModes);
        misc.rulesRefs = rulesRefs(SourceBookCode.TO_AUE, 157);
        // Tech Progression tweaked to combine IntOps with TRO Prototypes/3145 NTNU RS
        misc.techAdvancement.setTechBase(TechBase.ALL)
              .setTechRating(TechRating.C)
    ...
    public static MiscType createTracks() {
        ...
        misc.rulesRefs = rulesRefs(SourceBookCode.TM, 249);
        misc.techAdvancement.setTechBase(TechBase.ALL)
              .setTechRating(TechRating.C)
    ...
    public static MiscType createISClaw() {
        ...
        misc.rulesRefs = rulesRefs(SourceBookCode.TO_AUE, 101);
        // Tech Progression tweaked to combine IntOps with TRO Prototypes/3145 NTNU RS
        misc.techAdvancement.setTechBase(TechBase.ALL)
              .setIntroLevel(false)
              .setUnofficial(false)
    ...
    public static MiscType createHatchet() {
        ...
        misc.bv = BV_VARIABLE;
        misc.rulesRefs = rulesRefs(SourceBookCode.TM, 220);
        misc.techAdvancement.setTechBase(TechBase.IS)
              .setTechRating(TechRating.B)
    ...
    public static MiscType createISLance() {
        ...
        misc.toHitModifier = 1;
        misc.bv = BV_VARIABLE;
        misc.rulesRefs = rulesRefs(SourceBookCode.TO_AUE, 102);
        // Tech Progression tweaked to combine IntOps with TRO Prototypes/3145 NTNU RS
        misc.techAdvancement.setTechBase(TechBase.IS)
              .setIntroLevel(false)
              .setUnofficial(false)
    ...
    public static MiscType createRetractableBlade() {
        ...
        misc.setModes(modes);
        misc.rulesRefs = rulesRefs(SourceBookCode.TM, 236);
        misc.techAdvancement.setTechBase(TechBase.IS)
              .setIntroLevel(false)
              .setUnofficial(false)
              .setTechRating(TechRating.B)
    ...
    public static MiscType createISSmallShield() {
        ...
        misc.rulesRefs = rulesRefs(SourceBookCode.TO_AUE, 103);
        // Tech Progression tweaked to combine IntOps with TRO Prototypes/3145 NTNU RS
        misc.techAdvancement.setTechBase(TechBase.IS)
              .setIntroLevel(false)
              .setUnofficial(false)
    ...
    public static MiscType createISSmallVibroblade() {
        ...
        misc.setModes(modes);
        misc.rulesRefs = rulesRefs(SourceBookCode.TO_AUE, 104);
        // Tech Progression tweaked to combine IntOps with TRO Prototypes/3145 NTNU RS
        misc.techAdvancement.setTechBase(TechBase.IS)
              .setIntroLevel(false)
              .setUnofficial(false)
    ...
    public static MiscType createC3S() {
        ...
        misc.rulesRefs = rulesRefs(SourceBookCode.TM, 209);
        misc.techAdvancement.setTechBase(TechBase.IS)
              .setIntroLevel(false)
              .setUnofficial(false)
              .setTechRating(TechRating.E)
    ...
    public static MiscType createC3I() {
        ...
        misc.svSlots = 1;
        misc.cost = 750000;
        misc.rulesRefs = rulesRefs(SourceBookCode.TW, 133);
        // Tech Progression tweaked to combine IntOps with TRO Prototypes/3145 NTNU RS
    ...
    public static MiscType createISCASE() {
        ...
        misc.cost = 50000;
        misc.bv = 0;
        misc.rulesRefs = rulesRefs(SourceBookCode.TM, 210);
        misc.techAdvancement.setTechBase(TechBase.IS)
              .setIntroLevel(false)
              .setUnofficial(false)
              .setTechRating(TechRating.E)
    ...
    public static MiscType createISAPPod() {
        ...
        misc.flags = misc.flags.or(F_AP_POD,
              ...
              .andNot(F_FIGHTER_EQUIPMENT);
        misc.bv = 1;
        misc.rulesRefs = rulesRefs(SourceBookCode.TM, 204);
        misc.techAdvancement.setTechBase(TechBase.ALL)
              .setIntroLevel(false)
              .setUnofficial(false)
              .setTechRating(TechRating.B)
    ...
    public static MiscType createBloodhoundActiveProbe() {
        ...
        misc.setModes(Mounted.MODE_ON, Mounted.MODE_OFF);
        misc.setInstantModeSwitch(false);
        misc.rulesRefs = rulesRefs(SourceBookCode.TO_AUE, 90);
        // Tech Progression tweaked to combine IntOps with TRO Prototypes/3145 NTNU RS
        misc.techAdvancement.setTechBase(TechBase.IS)
              .setIntroLevel(false)
              .setUnofficial(false)
    ...
    public static MiscType createTHBBloodhoundActiveProbe() {
        ...
        misc.rulesRefs = rulesRefs(SourceBookCode.UNOFFICIAL, null);
;
        misc.techAdvancement.setTechBase(TechBase.IS)
              .setIntroLevel(false)
              .setUnofficial(true)
...
;
    ...
    public static MiscType createISArtemis() {
        ...
        misc.flags = misc.flags.or(F_ARTEMIS,
              ...
              F_SS_EQUIPMENT,
              F_HEAVY_EQUIPMENT);
        misc.rulesRefs = rulesRefs(SourceBookCode.TM, 206);
        misc.techAdvancement.setTechBase(TechBase.IS)
              .setIntroLevel(false)
              .setUnofficial(false)
              .setTechRating(TechRating.E)
    ...
    public static MiscType createISTargComp() {
        ...
        misc.setModes(modes);
        misc.rulesRefs = rulesRefs(SourceBookCode.TM, 238);
        misc.techAdvancement.setTechBase(TechBase.IS)
              .setIntroLevel(false)
              .setUnofficial(false)
              .setTechRating(TechRating.E)
    ...
    public static MiscType createHeatSink() {
        ...
        misc.setModes(Mounted.MODE_ON, Mounted.MODE_OFF);
        misc.setInstantModeSwitch(false);
        misc.rulesRefs = rulesRefs(SourceBookCode.TM, 221);
        misc.techAdvancement.setTechBase(TechBase.ALL)
              .setISAdvancement(DATE_ES, DATE_ES, DATE_ES, DATE_NONE, DATE_NONE)
              .setISApproximate(false, false, false, false, false)
              .setClanAdvancement(DATE_ES, DATE_ES, DATE_ES, DATE_NONE, DATE_NONE)
    ...
    public static MiscType createBackhoe() {
        ...
        misc.bv = 8;
        misc.industrial = true;
        misc.rulesRefs = rulesRefs(SourceBookCode.TM, 241);
        misc.techAdvancement.setTechBase(TechBase.ALL)
              .setIntroLevel(false)
              .setUnofficial(false)
              .setTechRating(TechRating.B)
    ...
    public static MiscType createLightBridgeLayer() {
        ...
        misc.industrial = true;
        misc.rulesRefs = rulesRefs(SourceBookCode.TM, 242);
        misc.techAdvancement.setTechBase(TechBase.ALL)
              .setIntroLevel(false)
              .setUnofficial(false)
              .setTechRating(TechRating.B)
    ...
    public static MiscType createMiningDrill() {
        ...
        misc.bv = 6;
        misc.industrial = true;
        misc.rulesRefs = rulesRefs(SourceBookCode.TM, 246);
        misc.techAdvancement.setTechBase(TechBase.ALL)
              .setIntroLevel(false)
              .setUnofficial(false)
              .setTechRating(TechRating.C)
    ...
    public static MiscType createChameleonLightPolarizationShield() {
        ...
        misc.bv = 0;
        misc.cost = 600000;
        misc.rulesRefs = rulesRefs(SourceBookCode.TO_AUE, 112);
        misc.techAdvancement.setTechBase(TechBase.IS)
              .setIntroLevel(false)
              .setUnofficial(false)
              .setTechRating(TechRating.E)
    ...
    public static MiscType createNullSignatureSystem() {
        ...
        misc.bv = 0;
        misc.cost = 1400000;
        misc.rulesRefs = rulesRefs(SourceBookCode.TO_AUE, 148);
        misc.techAdvancement.setTechBase(TechBase.IS)
              .setIntroLevel(false)
              .setUnofficial(false)
              .setTechRating(TechRating.E)
    ...
    public static StructureType createISCompositeStructure() {
        ...
        misc.omniFixedOnly = true;
        misc.rulesRefs = rulesRefs(SourceBookCode.TO_AUE, 154);
        // Tech Progression tweaked to combine IntOps with TRO Prototypes/3145 NTNU RS
        misc.techAdvancement.setTechBase(TechBase.IS)
              .setTechRating(TechRating.E)
              .setAvailability(AvailabilityValue.X, AvailabilityValue.X, AvailabilityValue.E, AvailabilityValue.D)
    ...
    public static StructureType createReinforcedStructure() {
        ...
        misc.omniFixedOnly = true;
        misc.rulesRefs = rulesRefs(SourceBookCode.TO_AUE, 155);
        // Tech Progression tweaked to combine IntOps with TRO Prototypes/3145 NTNU RS
        misc.techAdvancement.setTechBase(TechBase.ALL)
              .setTechRating(TechRating.E)
              .setAvailability(AvailabilityValue.X, AvailabilityValue.X, AvailabilityValue.E, AvailabilityValue.D)
    ...
    public static MiscType createTSM() {
        ...
        misc.omniFixedOnly = true;
        misc.bv = 0;
        misc.rulesRefs = rulesRefs(SourceBookCode.TM, 240);
        misc.techAdvancement.setTechBase(TechBase.IS)
              .setIntroLevel(false)
              .setUnofficial(false)
              .setTechRating(TechRating.E)
    ...
    public static MiscType createISBALightActiveProbe() {
        ...
        misc.setModes(Mounted.MODE_ON, Mounted.MODE_OFF);
        misc.setInstantModeSwitch(false);
        misc.rulesRefs = rulesRefs(SourceBookCode.TM, 252);
        misc.techAdvancement.setTechBase(TechBase.IS)
              .setIntroLevel(false)
              .setUnofficial(false)
              .setTechRating(TechRating.E)
    ...
    public static MiscType createCLBALightActiveProbe() {
        ...
        misc.setModes(Mounted.MODE_ON, Mounted.MODE_OFF);
        misc.setInstantModeSwitch(false);
        misc.rulesRefs = rulesRefs(SourceBookCode.TM, 348);
        misc.techAdvancement.setTechBase(TechBase.CLAN)
              .setIntroLevel(false)
              .setUnofficial(false)
              .setTechRating(TechRating.F)
    ...
    public static MiscType createSimpleCamo() {
        ...
        misc.flags = misc.flags.or(F_STEALTH, F_VISUAL_CAMO, F_BA_EQUIPMENT)
              ...
              .andNot(F_TANK_EQUIPMENT)
              .andNot(F_FIGHTER_EQUIPMENT);
        misc.rulesRefs = rulesRefs(SourceBookCode.TM, 253);
        misc.bv = 0;
        misc.techAdvancement.setTechBase(TechBase.IS)
              .setIntroLevel(false)
              .setUnofficial(false)
