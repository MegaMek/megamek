...
/**
 * Exception to catch when a {@link megamek.common.verifier.Ceil} is not passed to a method for weight calculations
 * within the {@link megamek.common.verifier.Structure} verifier.
 */
public class CeilNotProvidedForWeightException extends RuntimeException {
    public CeilNotProvidedForWeightException() {
        super("Ceil Not Provided For Weight Exception");
    }
}
