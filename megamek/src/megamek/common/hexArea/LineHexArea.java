...
/**
 * This class represents a line of hexes through the given point in the given hex row direction. The direction must be
 * between 0 and 5. Opposite directions are equal, e.g. directions 1 and 4 result in the same line.
 */
public class LineHexArea extends AbstractHexArea {
    ...
    /**
     * Creates a line of hexes through the given point in the given direction. The direction must be between 0 and 5.
