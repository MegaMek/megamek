...
/**
 * This class handles the get up step of a unit. It is used in the MoveStep compilation to calculate the movement of a
 * unit.
 *
 * @author Luana Coppio
 * @since 0.50.07
 */
class GetUpStep implements PhasePass {
    private static final EnumSet<MovePath.MoveStepType> TYPES = EnumSet.of(MovePath.MoveStepType.GET_UP);
