...
/**
 * This class handles the yaw step of a unit. It is used in the MoveStep compilation to calculate the movement of a
 * unit.
 *
 * @author Luana Coppio
 * @since 0.50.07
 */
class YawStep implements PhasePass {
    private static final EnumSet<MovePath.MoveStepType> TYPES = EnumSet.of(MovePath.MoveStepType.YAW);
