...
public class OptionsConstants {
    ...
    public static final String ADVANCED_BUILDING_EXPANDED_CF = "building_expanded_cf";
    public static final String ADVANCED_BUILDING_EXPANDED_COLLAPSE = "building_expanded_collapse";
