...
public class DestructionAwareDestinationPathfinder extends BoardEdgePathFinder {
     ...
     * Ignores move cost and makes note of hexes that need to be cleared for the
     * path to be viable.
     */
     ...
     * path and updates the set of visited coordinates so we don't visit them again.
     *
     ...
     * child path to the list of child paths.
     */
    ...
    /**
     * Utility function that returns true if an attack on the building in the given
     ...
     * to the internal "destination edge" than the other.
     *
     * @author NickAragua
     */
    private class AStarComparator implements Comparator<BulldozerMovePath> {
        ...
        /**
         * compare the first move path to the second Favors paths that move closer to
         * the destination edge first. in case of tie, favors paths that cost less MP
         */
        @Override
