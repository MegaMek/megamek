...
public class BattleArmorTROView extends TROView {
	...
	protected void initModel(EntityVerifier verifier) {
		addBasicData(ba);
		addEntityFluff(ba);
		setModelData("formatBasicDataRow", new FormatTableRowMethod(new int[] { 25, 20, 8, 8},
		...
		setModelData("legAttack", (ba.canDoMechanizedBA()
		...
		int nameWidth = addBAEquipment();
		setModelData("formatEquipmentRow", new FormatTableRowMethod(new int[] { nameWidth, 8, 12, 8},
