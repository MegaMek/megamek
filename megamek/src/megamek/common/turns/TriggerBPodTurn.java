...
/**
 * A type of game turn that allows only one specific entity to trigger their Anti-Battle Armor pods against attacking
 * infantry/BA.
 */
public class TriggerBPodTurn extends SpecificEntityTurn {
    ...
    /**
     * @return true if the entity matches this game turn, even if the entity has declared an action.
     */
    @Override
