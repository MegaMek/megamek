...
public class Terrains implements Serializable {
    ...
    // Solaris 7 random elevator (moves randomly based on d6 roll each turn)
    // level = elevation it moves to, exits = d6 rolls it moves on
    public static final int SOLARIS_ELEVATOR = 36;
    /** @deprecated use {@link #SOLARIS_ELEVATOR}; renamed to distinguish it from {@link #INDUSTRIAL_ELEVATOR}. */
    @Deprecated(since = "0.50.11", forRemoval = true)
    public static final int ELEVATOR = SOLARIS_ELEVATOR;
    ...
    public static final int INDUSTRIAL_ELEVATOR = 61;
    ...
    private static final String[] names = { "none", "woods", "water", "rough", "rubble", "jungle", "sand", "tundra",
                                            ...
                                            "fuel_tank_magn", "impassable", "solaris_elevator", "fortified", "screen",
                                            "fluff",
                                            ...
                                            "bridge_repaired", "industrial_elevator" };
    ...
    public static String getDisplayName(int type, int level) {
        switch (type) {
            ...
            case SOLARIS_ELEVATOR:
                return "Solaris Elevator";
    ...
    protected static Hashtable<String, Integer> getHash() {
        if (hash == null) {
            ...
            // Legacy board-file token: the Solaris 7 elevator was named "elevator" before the
            // industrial elevator was added; existing .board files must keep parsing.
            hash.put("elevator", SOLARIS_ELEVATOR);
        }
        return hash;
    }
