...
public class FluidGunCoolHandler extends AmmoWeaponHandler {
    private static final MMLogger LOGGER = MMLogger.create(FluidGunCoolHandler.class);
    ...
    @Override
    protected void handleEntityDamage(Entity entityTarget, Vector<Report> vPhaseReport, IBuilding building, int hits,
