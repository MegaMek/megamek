...
public class ThunderboltScatterableHandler extends MissileWeaponHandler{
    public ThunderboltScatterableHandler(ToHitData t, WeaponAttackAction w, Game g, TWGameManager m)
    ...
    protected boolean specialResolution(Vector<Report> vPhaseReport,
        ...
        int density = ammoType.getDamagePerShot();
