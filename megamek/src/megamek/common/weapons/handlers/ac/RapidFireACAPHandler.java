...
/**
 * Handles rapid-fire autocannon attacks with armor-piercing ammunition. Combines the rapid-fire mechanics (jam checks,
 * cluster table) with the AP-specific damage handling (TAC rolls via makeArmorPiercing).
 *
 * @see RapidFireACWeaponHandler
 * @see ACAPHandler
 */
public class RapidFireACAPHandler extends RapidFireACWeaponHandler {
    @Serial
    private static final long serialVersionUID = -3352115006182839L;

    public RapidFireACAPHandler(ToHitData toHitData, WeaponAttackAction weaponAttackAction, Game game,
