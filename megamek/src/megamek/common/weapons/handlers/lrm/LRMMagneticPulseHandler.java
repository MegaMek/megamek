...
public class LRMMagneticPulseHandler extends LRMHandler {
    ...
    /** Warheads needed per +1 heat for LRM-class launchers (IO p.62). */
    private static final int LRM_HEAT_DIVISOR = 5;

    private boolean effectApplied = false;

    public LRMMagneticPulseHandler(ToHitData t, WeaponAttackAction w, Game g, TWGameManager m)
