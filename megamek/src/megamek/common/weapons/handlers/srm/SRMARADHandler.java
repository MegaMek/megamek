 ...
 * <p>
 * Cluster Modifiers: - +1 against targets with qualifying electronics (unless blocked by ECM) - 0 if target has
 * electronics but ECM blocks (and no Narc override) - -2 against targets without electronics (minimum 2 hits enforced
 * by engine)
 * <p>
 ...
 * @since 2025-01-17
 */
public class SRMARADHandler extends SRMHandler {
    @Serial
    private static final long serialVersionUID = -8675309867530986754L;

    public SRMARADHandler(ToHitData t, WeaponAttackAction w, Game g, TWGameManager m)
