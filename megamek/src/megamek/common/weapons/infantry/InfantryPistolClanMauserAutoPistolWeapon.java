 ...
 * @author Ben Grills
 */
public class InfantryPistolClanMauserAutoPistolWeapon extends InfantryWeapon {
    ...
    public InfantryPistolClanMauserAutoPistolWeapon() {
        ...
        techProgression.setAvailability( new int[] { RATING_X, RATING_B, RATING_C, RATING_B });
    }
}
