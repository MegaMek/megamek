...
public class InfantryPistolClanMauserNeedlerPistolWeapon extends InfantryWeapon {
    ...
    public InfantryPistolClanMauserNeedlerPistolWeapon() {
        ...
        addLookupName("CL InfantryMauserneedlerpistol");
        addLookupName("Clan M&G Flechette Pistol");
        ...
        techAdvancement.setAvailability( new int[] { RATING_X, RATING_B, RATING_C, RATING_C });
    }
}
