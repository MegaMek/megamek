 ...
 * @author Ben Grills
 */
public class InfantryPistolISGyrojetPistolWeapon extends InfantryWeapon {
    ...
    public InfantryPistolISGyrojetPistolWeapon() {
        ...
        techProgression.setProgression(2615, 2625, 2700);
        techProgression.setTechRating(RATING_D);
        techProgression.setAvailability( new int[] { RATING_D, RATING_D, RATING_C, RATING_B });
    }
}
