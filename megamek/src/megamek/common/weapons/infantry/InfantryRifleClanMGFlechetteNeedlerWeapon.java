 ...
 * @author Ben Grills
 */
public class InfantryRifleClanMGFlechetteNeedlerWeapon extends InfantryWeapon {
    ...
    public InfantryRifleClanMGFlechetteNeedlerWeapon() {
        super();
        ...
        availRating = new int[] { RATING_X,RATING_C ,RATING_C ,RATING_B};
        techRating = RATING_D;
        rulesRefs =" 273, TM";
        techProgression.setTechBase(TechProgression.TECH_BASE_CLAN);
        techProgression.setClanProgression(DATE_NONE, DATE_NONE, 2807);
        techProgression.setTechRating(RATING_D);
        techProgression.setAvailability( new int[] { RATING_X, RATING_C, RATING_C, RATING_B });
    }
}
