 ...
 * @author Ben Grills
 */
public class InfantryRifleISMGFlechetteNeedlerWeapon extends InfantryWeapon {
    ...
    public InfantryRifleISMGFlechetteNeedlerWeapon() {
        super();
        ...
        techProgression.setISProgression(2315, 2325, 2350);
        techProgression.setTechRating(RATING_D);
        techProgression.setAvailability( new int[] { RATING_C, RATING_C, RATING_C, RATING_B });
    }
}
