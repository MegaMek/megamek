...
public class InfantryRiflePulseLaserWeapon extends InfantryWeapon {
    ...
    public InfantryRiflePulseLaserWeapon() {
        ...
        infantryRange = 1;
        introDate = 2673;
        techLevel.put(2673, TechConstants.T_IS_EXPERIMENTAL);
        techLevel.put(2680, TechConstants.T_IS_ADVANCED);
        techLevel.put(2700, TechConstants.T_IS_TW_NON_BOX);
        availRating = new int[] { RATING_D,RATING_E ,RATING_C ,RATING_C};
        techRating = RATING_D;
        rulesRefs = "273, TM";
        techProgression.setTechBase(TechProgression.TECH_BASE_IS);
        techProgression.setISProgression(2673, 2680, 2700);
        techProgression.setTechRating(RATING_D);
        techProgression.setAvailability( new int[] { RATING_D, RATING_E, RATING_C, RATING_C });
    }
}
