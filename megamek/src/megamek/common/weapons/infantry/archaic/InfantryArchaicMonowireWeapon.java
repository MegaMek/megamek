...
public class InfantryArchaicMonowireWeapon extends InfantryWeapon {
     ...
     */
    @Serial
    private static final long serialVersionUID = -3071214003412050213L;
    ...
    public InfantryArchaicMonowireWeapon() {
        ...
        techAdvancement.setTechBase(TechBase.ALL).setISAdvancement(2100, 2100, DATE_NONE, DATE_NONE, DATE_NONE)
