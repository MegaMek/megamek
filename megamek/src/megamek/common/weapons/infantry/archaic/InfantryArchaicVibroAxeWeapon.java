...
public class InfantryArchaicVibroAxeWeapon extends InfantryWeapon {
     ...
     */
    @Serial
    private static final long serialVersionUID = -7211680632135844092L;
    ...
    public InfantryArchaicVibroAxeWeapon() {
        ...
        techAdvancement.setTechBase(TechBase.ALL).setAdvancement(2435, 2445, 2600, DATE_NONE, DATE_NONE)
              .setApproximate(true, false, false, false, false).setPrototypeFactions(Faction.LC)
