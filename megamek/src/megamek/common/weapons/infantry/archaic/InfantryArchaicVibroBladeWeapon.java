...
public class InfantryArchaicVibroBladeWeapon extends InfantryWeapon {
     ...
     */
    @Serial
    private static final long serialVersionUID = 395705110861045558L;
    ...
    public InfantryArchaicVibroBladeWeapon() {
        ...
        techAdvancement.setTechBase(TechBase.ALL).setAdvancement(2398, 2400, DATE_NONE, DATE_NONE, DATE_NONE)
              .setApproximate(true, false, false, false, false).setPrototypeFactions(Faction.FW)
