...
public class InfantryLaserPistolDarklightIVLaserPistol extends InfantryWeapon {

    @Serial
    private static final long serialVersionUID = -7512513178884213779L; // Update for each unique class
