...
public class InfantryPistolHoldOutNeedlerPistolWeapon extends InfantryWeapon {
     ...
     */
    @Serial
    private static final long serialVersionUID = 2987241672866257418L;
    ...
    public InfantryPistolHoldOutNeedlerPistolWeapon() {
        ...
        techAdvancement.setTechBase(TechBase.ALL).setISAdvancement(2510, 2515, 2570, DATE_NONE, DATE_NONE)
