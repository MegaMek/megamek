...
public class InfantryPistolNambuAutoPistolWeapon extends InfantryWeapon {
     ...
     */
    @Serial
    private static final long serialVersionUID = -7270541835000340351L;
    ...
    public InfantryPistolNambuAutoPistolWeapon() {
        ...
        techAdvancement.setTechBase(TechBase.ALL).setISAdvancement(2535, 2540, 2600, DATE_NONE, DATE_NONE)
