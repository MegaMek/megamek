...
public class InfantryPistolSternsnachtPistolWeapon extends InfantryWeapon {
     ...
     */
    @Serial
    private static final long serialVersionUID = 1465927514538331910L;
    ...
    public InfantryPistolSternsnachtPistolWeapon() {
        ...
        techAdvancement.setTechBase(TechBase.IS).setISAdvancement(2882, 2885, 2950, DATE_NONE, DATE_NONE)
