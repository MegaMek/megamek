...
public class InfantryRifleGyrojetRifleWeapon extends InfantryWeapon {
     ...
     */
    @Serial
    private static final long serialVersionUID = 4853648851153245961L;
    ...
    public InfantryRifleGyrojetRifleWeapon() {
        ...
        techAdvancement.setTechBase(TechBase.ALL).setISAdvancement(2535, 2540, 2570, DATE_NONE, DATE_NONE)
