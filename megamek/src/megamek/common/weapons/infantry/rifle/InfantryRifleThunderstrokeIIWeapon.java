...
public class InfantryRifleThunderstrokeIIWeapon extends InfantryWeapon {
     ...
     */
    @Serial
    private static final long serialVersionUID = -2715064853426067150L;
    ...
    public InfantryRifleThunderstrokeIIWeapon() {
        ...
        techAdvancement.setTechBase(TechBase.IS).setISAdvancement(3058, 3062, 3090, DATE_NONE, DATE_NONE)
