...
public class InfantryShotgunAMIKeymaster15 extends InfantryWeapon {

    @Serial
    private static final long serialVersionUID = 5322254995778339074L;

    public InfantryShotgunAMIKeymaster15() {
        super();

        name = "Shotgun (AMI Keymaster-15)";
