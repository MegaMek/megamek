...
public class InfantryShotgunHastariIII extends InfantryWeapon {

    @Serial
    private static final long serialVersionUID = -2465804467767253761L;

    public InfantryShotgunHastariIII() {
        super();

        name = "Shotgun (Hastari III)";
