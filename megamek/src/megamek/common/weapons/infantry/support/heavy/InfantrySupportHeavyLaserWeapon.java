...
public class InfantrySupportHeavyLaserWeapon extends InfantryWeapon {
     ...
     */
    @Serial
    private static final long serialVersionUID = 77710152611859726L;
    ...
    public InfantrySupportHeavyLaserWeapon() {
        ...
        techAdvancement.setTechBase(TechBase.ALL).setISAdvancement(2400, 2405, 2450, DATE_NONE, DATE_NONE)
