 ...
 * successful scan (Standard Missions, Objectives - Potential Objectives). Note that this trigger reacts every time
 * it is checked once the objective is confirmed; use {@link OnceTrigger} to limit it.
 *
...
public record ObjectiveConfirmedTrigger(String objectiveName) implements Trigger {
    ...
    public String toString() {
        return "ObjectiveConfirmed: " + objectiveName;
    }
}
