 ...
 * 
 * Implementors must implement a publicly accessible default constructor and
 * must not store state outside of methods.
 * 
...
public interface VictoryFactory {
    /**
     * @param conditions -
     *            depending on the implementation describes either the
