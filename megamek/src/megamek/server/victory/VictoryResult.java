...
public final class VictoryResult {
    ...
    /**
     * Incorporates the player and team scores of the given other VictoryResult to this one's scores. Where scores for
     * the same player/team IDs exist in both, the scores are added.
     *
    ...
    /**
     * @return List of reports generated by the victory checking. This is usually empty when no victory occurs, but
     *       might contain reports about VictoryConditions which are about to be filled or are time triggered
     */
    ...
    /**
     * Creates and returns victory/draw reports if this is a victory and updates the game's settings to reflect the
     * victory result.
     *
