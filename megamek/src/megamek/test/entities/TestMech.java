...
public class TestMech extends TestEntity
{
    ...
    {
        return makeLength("Cockpit: ", getPrintSize()-5)+
            makeWeightString(getWeightCockpit())+"\n"+
            makeLength("Gyro: ", getPrintSize()-5)+
            ...
            Vector allocation)
    {
        ...
        allocation.add(mounted);
        allocation.add(new Integer(criticals));
        allocation.add(new Integer(count));
        return false;
    }
