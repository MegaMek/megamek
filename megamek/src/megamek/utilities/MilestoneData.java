 ...
 * @param useFallbackHyperlink {@code true} if {@link #getMegaMekUrl()}, {@link #getMegaMekLabUrl()} &
 *                             {@link #getMekHQUrl()} should all return their project releases page, instead of a page
