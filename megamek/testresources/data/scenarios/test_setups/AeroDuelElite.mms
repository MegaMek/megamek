...
MMSVersion: 2
name: Aerospace Duel (elite crews)
description: >
  ...
  blocks A2A fire over ground maps - the LosEffects altitude wart). Crews are uniformly ELITE (2/2); Dylan Fountain (piloting 6) is the green pilot whose 28% Split-S motivated the odds floor.
