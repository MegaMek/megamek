 ...
 */
class BehaviorSettingsFactoryTestConstants {

    static final String NM_RECKLESS = "reckless";
    /**
     ...
     */
    static final String RECKLESS = "    <behavior>\n" +
    ...
    static final String NM_COWARDLY = BehaviorSettingsFactory.COWARDLY_BEHAVIOR_DESCRIPTION;
    /**
     * Home Edge: {@link CardinalEdge#NORTH} <br>
     ...
     * Strategic Targets: None
     */
    static final String COWARDLY = "    <behavior>\n" +
    ...
    static final String NM_ESCAPE = BehaviorSettingsFactory.ESCAPE_BEHAVIOR_DESCRIPTION;
    /**
     * Home Edge: {@link CardinalEdge#NORTH} <br>
     * Forced Withdrawal: True <br>
     * Go Home: True <br>
     ...
     * Strategic Targets: None
     */
    static final String ESCAPE = "    <behavior>\n" +
            "        <name>" + NM_ESCAPE + "</name>\n" +
            "        <retreatEdge>0</retreatEdge>\n" +
            "        <destinationEdge>0</destinationEdge>\n" +
            "        <forcedWithdrawal>true</forcedWithdrawal>\n" +
    ...
    static final String NM_DEFAULT = BehaviorSettingsFactory.DEFAULT_BEHAVIOR_DESCRIPTION;
    /**
     ...
     */
    static final String DEFAULT = "    <behavior>\n" +
    ...
    /**
     * Contains 4 behaviors: {@link #DEFAULT}, {@link #RECKLESS}, {@link #COWARDLY}
     * and {@link #ESCAPE}.
     */
    static final String GOOD_BEHAVIOR_SETTINGS_FILE = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\"?>\n"
            +
