...
class RulesChartsTest {
    ...
    void coreAndTotalWarfareRulesExerciseChartLogic() {
        ...
        assertTrue(core.getLocationName(Mek.LOC_LEFT_ARM, false).equals(Messages.getString("Locations.LeftArm")));
        assertTrue(total.getLocationName(Mek.LOC_RIGHT_ARM, true)
                        .equals(Messages.getString("Locations.FrontRightLeg")));
