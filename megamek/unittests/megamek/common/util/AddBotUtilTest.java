...
public class AddBotUtilTest {
    ...
    public void beforeEach() {
        ...
        final TestBot mockTestBot = mock(TestBot.class);
        when(mockTestBot.connect()).thenReturn(true);
        when(mockTestBot.getGame()).thenReturn(mockGame);
        ...
        doReturn(mockTestBot).when(testAddBotUtil).makeNewTestBotClient(
                any(Player.class), anyString(), anyInt());
    }
    ...
    public void testReplacePlayerWithABot() {
        ...
        assertEquals("TestBot has replaced MockBot.\n", actual);
    }

    @Test
    public void ExplicitlySpecifyingTestBot() {
        // Test explicitly specifying TestBot.
        final String actual = testAddBotUtil.addBot(
                new String[] { "/replacePlayer", "-b:TestBot", BOT_PLAYER_NAME }, mockGame,
    ...
    public void testReplacingNonGhostPlayer() {
        ...
        final String actual = testAddBotUtil.addBot(
                new String[] { "/replacePlayer", "-b:TestBot", HUMAN_PLAYER_NAME }, mockGame,
                mockClient.getHost(), mockClient.getPort());
    ...
    public void testReplacingNonExistentPlayer() {
        ...
        final String actual = testAddBotUtil.addBot(
                new String[] { "/replacePlayer", "-b:TestBot", "invalid player" }, mockGame,
                mockClient.getHost(), mockClient.getPort());
    ...
    public void testReplaceBotWithInvalidBotName() {
        ...
        final String actual = testAddBotUtil.addBot(
                ...
                mockClient.getHost(), mockClient.getPort());
        assertEquals("Unrecognized bot: 'InvalidBot'.  Defaulting to TestBot.\nTestBot has replaced MockBot.\n", actual);
    }
