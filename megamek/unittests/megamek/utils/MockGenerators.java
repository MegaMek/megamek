...
public class MockGenerators {
    ...
    /**
     * Generates an entity at specific coordinates Vital statistics: - ID: 1 Max - weapon range: 21 (LRMs, obviously) -
     * Final path coordinates: (10, 10) - Final path facing: straight north - No SPAs - Default crew
     *
    ...
    /**
     * Generates a BipedMek at specific coordinates Vital statistics: - No SPAs - Default crew
     *
     * @param x X Coord on Board
     * @param y Y Coord on Board
     *
     ...
     *
     * @return A mocked {@link TargetRoll} with the requested value and "mock" as description.
     */
