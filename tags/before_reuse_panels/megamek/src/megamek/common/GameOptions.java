...
public class GameOptions extends Options implements Serializable {
    ...
    public void initialize() {
        ...
        addOption(ruleBreakers, new GameOption("inf_and_protos_move_last", "Infantry and Protomechs move after Meks and Vehicles", "If checked, all Meks and Vehicles will move before the first Infantry platoon or Protomech.  The move order of Meks and Vehicles ignores the presence of Infantry and Protomechs.\n\nMutually exclusive with \"" + Game.INF_AND_PROTOS_MOVE_MULTI + " Infantry/Protomechs for every Mek or Vehicle\".\n\nUnchecked by default.", false));
        addOption(ruleBreakers, new GameOption("inf_and_protos_deploy_last", "Infantry and Protomechs deploy after Meks and Vehicles", "If checked, all Meks and Vehicles will deploy before the first Infantry platoon or Protomech.\n\nThe above option, \"Infantry and Protomechs move after Meks and Vehicles\" must also be checked to use this option.\n\nUnchecked by default.", false));
        addOption(ruleBreakers, new GameOption("inf_and_protos_move_multi", Game.INF_AND_PROTOS_MOVE_MULTI + " Infantry/Protomechs for every Mek or Vehicle", "If checked, " + Game.INF_AND_PROTOS_MOVE_MULTI + " infantry platoons/protomechs will have to move in place of a single Mek or Vehicle.  If there are less than " + Game.INF_AND_PROTOS_MOVE_MULTI + " platoons/protos remaining, they all must move.  The move order includes the presence of Infantry and Protomechs.\n\nMutually exclusive with \"Infantry and Protomechs move after Meks and Vehicles\".\n\nUnchecked by default.", false));
