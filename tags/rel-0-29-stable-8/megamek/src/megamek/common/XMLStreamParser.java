 ...
 * If unexpected entities are encountered while parsing a well-formed stream,
 * a warning message will be available.
 *
...
public class XMLStreamParser implements XMLResponder {
     ...
     * Not every attribute is valid for every element.
     */
     ...
     *
     * @return  The <code>String</code> warning message from the last parse.
     *          If there is no warning message, then an <code>null</code>
     *          value is returned.
     */
     ...
     * Entities may have been parsed out of the stream, even if errors
     * were encountered.
     *
    ...
    public void recordNotationDeclaration( String name,
                                           String pubID,
                                           String sysID )
    ...
    public void recordEntityDeclaration( String name,
                                         String value,
                                         String pubID,
                                         String sysID,
                                         String notation )
    ...
    public void recordElementDeclaration( String name,
                                          String content )
        throws ParseException {
        // Do nothing.
    }

    public void recordAttlistDeclaration( String element,
                                          String attr,
                                          boolean notation,
                                          String type,
                                          String defmod,
    ...
    public void recordDoctypeDeclaration( String name,
                                          String pubID,
                                          String sysID )
        throws ParseException {
        // Do nothing.
    ...
    public void recordElementStart( String name,
                                    Hashtable attr )
        throws ParseException {
        ...
        if ( name.equals( UNIT ) ) {
            ...
            if ( this.entity != null ) { 
                this.warning.append
                    ( "Found a unit while parsing an Entity.\n" );
            }
            ...
            if ( this.entity != null ) {
                this.warning.append
                    ( "Found another Entity while parsing an Entity.\n" );
            }
            ...
            // Start a new entity.
                ...
                if ( chassis == null || chassis.length() == 0 ) {
                    this.warning.append
                        ( "Could not find chassis for Entity.\n" );
                }
                else {
                    ...
                    if ( ms == null ) {
                        this.warning.append
                            ( "Could not find Entity with chassis: " );
            ...
            if ( this.entity == null ) {
                this.warning.append
                    ( "Found a pilot outside of an Entity.\n" );
            }
            ...
            if ( this.entity == null ) {
                this.warning.append
                    ( "Found a location outside of an Entity.\n" );
            }
            ...
            // Handle the location.
                ...
                if ( index == null || index.length() == 0 ) {
                    ...
                    if ( indexVal < 0 || indexVal > 7 ) {
                        this.warning.append( "Found invalid index value for location: " )
                            .append( index )
                            .append( ".\n" );
                        return;
                    }
                    else if ( indexVal >= entity.locations() ) {
                        this.warning.append( "The entity, " )
                        ...
                        try {
                            ...
                            this.warning.append( "Found invalid isDestroyed value: " )
                                .append( destroyed )
                                .append( ".\n" );
                        }
            ...
            if ( this.entity == null ) {
                this.warning.append
                    ( "Found armor outside of an Entity.\n" );
            }
            ...
            // Handle the location.
                ...
                if ( points == null || points.length() == 0 ) {
                    this.warning.append
                        ( "Could not find points for armor.\n" );
                }
                else {
                    ...
                    if ( type == null || type.equals( FRONT ) ) {
                        ...
                        if ( !this.entity.hasRearArmor( this.loc ) ) {
                            this.warning.append( "The entity, " )
                                ...
                                .append( this.loc )
                                .append( ".\n" );
                        } else if ( this.entity.getOArmor(this.loc, true) <
                                    pointsVal ) {
                            this.warning.append( "The entity, " )
                                .append( this.entity.getShortName() )
                                .append( " does not start with " )
            ...
            if ( this.entity == null ) {
                this.warning.append
                    ( "Found a slot outside of an Entity.\n" );
            }
            ...
            // Handle the location.
                ...
                if ( index == null || index.length() == 0 ) {
                    ...
                    if ( index.equals( NA ) ) {
                        ...
                        this.warning.append( "Found invalid index value for slot: " )
                            .append( index )
                            .append( ".\n" );
                        return;
                    }
                    ...
                    if ( slot == null ) {
                        if ( !type.equals( EMPTY ) ) {
                            this.warning.append( "Could not find the " )
                                .append( type )
                    ...
                    if ( slot.getType() == CriticalSlot.TYPE_SYSTEM ) {
                        ...
                        Mounted mounted = this.entity.getEquipment
                            ( slot.getIndex() );
    ...
    public void recordElementEnd( String name )
        throws ParseException {
        ...
        if ( name.equals( UNIT ) ) {
            ...
            if ( this.entity != null ) { 
                this.warning.append
                    ( "End of unit while parsing an Entity.\n" );
            ...
            if ( this.entity == null ) {
                this.warning.append
                    ( "Found end of Entity, but not parsing an Entity.\n" );
            } else {
            ...
            if ( this.entity == null ) {
                this.warning.append
                    ( "Found end of location, but not parsing an Entity.\n" );
            }

            // Are we in the middle of parsing an Entity's location?
            else if ( this.loc == Entity.LOC_NONE ) {
                this.warning.append
                    ( "Found end of location, but not parsing a location.\n" );
    ...
    public InputStream resolveExternalEntity( String name,
                                              String pubID,
                                              String sysID )
        throws ParseException {
        // Return nothing.
    ...
    public InputStream resolveDTDEntity( String name,
                                         String pubID,
                                         String sysID )
        throws ParseException {
        // Return nothing.
