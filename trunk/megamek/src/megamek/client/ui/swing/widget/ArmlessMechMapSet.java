...
public class ArmlessMechMapSet implements DisplayMapSet{
    ...
    private Polygon leftTorso =  new Polygon( new int[]{54,48,48,62,62,53,43,41,
                                 41,31,29,27,25,26,47},
                                 new int[] {82,45,36,36,32,32,22,22,20,25,27,33,
                                 37,47,82}, 15);
       //right Torso
    private Polygon rightTorso  = new Polygon( new int[]{70,76,76,62,62,71,81,
                                  83,83,93,95,97,99,98,77},
                                  new int[] {82,45,36,36,32,32,22,22,20,25,27,
                                  33,37,47,82}, 15);
      //Left Leg
      
    private Polygon leftLeg = new Polygon(new int[] {0,7,37,47,54,54,61,34,40,
                              40,34,33,7,6,0},
                              new int[] {104,104,65,82,82,85,85,102,104,121,123,
                              129,129,122,122},15);
       //right Leg
    private Polygon rightLeg = new Polygon(new int[] {125,118,88,77,70,70,64,91,
                              85,85,91,92,118,119,125},
                              new int[] {104,104,63,82,82,85,85,102,104,121,
                              123,129,129,122,122},15);
    ...
    public ArmlessMechMapSet(Component c){
        comp = c;
        setAreas();
        setLabels();
        setGroups();
    ...
    private void setLabels(){
        ...
        labels[Mech.LOC_LLEG] = WidgetUtils.createLabel(Messages.getString("MechMapSet.l_LL"), fm, Color.black,28,92); //$NON-NLS-1$
        labels[Mech.LOC_RLEG] = WidgetUtils.createLabel(Messages.getString("MechMapSet.l_RL"), fm, Color.black,98,92); //$NON-NLS-1$
    ...
    private void setGroups(){
        ...
        //content.addArea(new PMSimplePolygonArea(new Polygon(new int[]{-7,-6,-7}, new int[]{18,19,19},3)));
