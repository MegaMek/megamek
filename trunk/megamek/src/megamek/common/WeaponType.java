...
public class WeaponType extends EquipmentType {
    ...
    private static WeaponType createISLargePulseLaser() {
        ...
        weapon.tonnage = 7.0f;
        weapon.criticals = 2;
        weapon.flags |= F_LASER | F_ENERGY | F_PULSE;
        weapon.bv = 119;
        weapon.cost = 175000;
    ...
    private static WeaponType createISSmallPulseLaser() {
        ...
        weapon.tonnage = 1.0f;
        weapon.criticals = 1;
        weapon.flags |= F_LASER | F_ENERGY | F_BURST_FIRE | F_PULSE;
        weapon.bv = 12;
        weapon.cost = 16000;
    ...
    private static WeaponType createCLSmallPulseLaser() {
        ...
        weapon.tonnage = 1.0f;
        weapon.criticals = 1;
        weapon.flags |= F_LASER | F_ENERGY | F_PULSE | F_BURST_FIRE;
        weapon.bv = 24;
        weapon.cost = 16000;
    ...
    private static WeaponType createCLMicroPulseLaser() {
        ...
        weapon.tonnage = 0.5f;
        weapon.criticals = 1;
        weapon.flags |= F_LASER | F_NO_FIRES | F_ENERGY | F_PULSE | F_BURST_FIRE;
        weapon.bv = 12;
        weapon.cost = 12500;
    ...
    private static WeaponType createTwinSmallPulseLaser() {
        ...
        weapon.tonnage = 0.0f;
        weapon.criticals = 0;
        weapon.flags |= F_LASER | F_MISSILE_HITS | F_NO_FIRES| F_ENERGY | F_PULSE;
        weapon.bv = 0;
    ...
    private static WeaponType createISMediumPulseLaserPrototype() {
        ...
        weapon.tonnage = 2.0f;
        weapon.criticals = 1;
        weapon.flags |= F_LASER | F_ENERGY | F_PROTOTYPE | F_PULSE;
        weapon.bv = 48;
        weapon.cost = 60000;
