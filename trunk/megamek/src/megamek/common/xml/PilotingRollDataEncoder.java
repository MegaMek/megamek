...
/**
 * Objects of this class can encode a <code>PilotingRollData</code> object as XML
...
public class PilotingRollDataEncoder {
     ...
     *
     * @param   option - the <code>PilotingRollData</code> to be encoded.
     ...
     *          contain a valid <code>PilotingRollData</code>.
     */
    public static PilotingRollData decode( ParsedXML node, Game game ) {
        return null;
    }
