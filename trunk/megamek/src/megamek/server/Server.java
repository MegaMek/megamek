	...
	implements Runnable
{
    ...
    public Vector               attacks = new Vector();
    public Vector               pilotRolls = new Vector();
    
    public StringBuffer         roundReport = new StringBuffer();
    public StringBuffer         phaseReport = new StringBuffer();
