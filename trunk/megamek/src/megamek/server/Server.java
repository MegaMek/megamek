...
implements Runnable {
    ...
    private class WeaponResult {
        ...
        public ToHitData toHit; // stored before ammo depletion, jams
        public int roll;
        public boolean revertsToSingleShot;
    ...
    private WeaponResult preTreatWeaponAttack(WeaponAttackAction waa) {
        ...
        for (int x = 0; x < vCounters.size(); x++) {
            ...
            amsHits = Math.min(mAmmo.getShotsLeft(), amsHits);
    ...
    private void resolveWeaponAttack(WeaponResult wr, int lastEntityId) {
        ...
        phaseReport.append("rolls " + wr.roll + " : ");
        ...
        while (hits > 0) {
            ...
            if(te instanceof HexEntity) {
              ...
              if(!wtype.hasFlag(WeaponType.F_FLAMER)) {
                ...
                phaseReport.append("    Checking to clear woods; needs " + TN + ", rolls " + woodsRoll + ": ");
              ...
              phaseReport.append("rolls " + fireRoll + " : ");
              if(fireRoll >= TN) {
